...
# Awesome FastAPI | [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 457,321 | 🐛 65 | 📅 2026-04-19 with stars
...
* [SQLAlchemy Admin](https://github.com/aminalaee/sqladmin) ⭐ 2,711 | 🐛 77 | 🌐 Python | 📅 2026-04-19 - Admin Panel for FastAPI/Starlette that works with SQLAlchemy models.
* [FastAPI Amis Admin](https://github.com/amisadmin/fastapi-amis-admin) ⭐ 1,538 | 🐛 77 | 🌐 Python | 📅 2025-12-15 - A high-performance, efficient and easily extensible FastAPI admin framework.
* [Starlette Admin](https://github.com/jowilf/starlette-admin) ⭐ 989 | 🐛 85 | 🌐 Python | 📅 2026-04-20 - Admin framework for FastAPI/Starlette, supporting SQLAlchemy, SQLModel, MongoDB, and ODMantic.
...
* [FastAPI Users](https://github.com/fastapi-users/fastapi-users) ⭐ 6,089 | 🐛 5 | 🌐 Python | 📅 2026-03-30 - Account management, authentication, authorization.
* [AuthX](https://github.com/yezz123/AuthX) ⭐ 1,167 | 🐛 5 | 🌐 Python | 📅 2026-04-20 - Customizable Authentications and Oauth2 management for FastAPI.
...
* [Piccolo](https://github.com/piccolo-orm/piccolo) ⭐ 1,889 | 🐛 40 | 🌐 Python | 📅 2026-04-15 - An async ORM and query builder, supporting Postgres and SQLite, with batteries (migrations, security, etc).
...
* [Fastapi-SQLA](https://github.com/dialoguemd/fastapi-sqla) ⭐ 443 | 🐛 12 | 🌐 Python | 📅 2026-04-20 - SQLAlchemy extension for FastAPI with support for pagination, asyncio, and pytest.
...
* [asyncpgsa](https://github.com/CanopyTax/asyncpgsa) ⭐ 510 | 🐛 15 | 🌐 Python | 📅 2024-02-17 - A wrapper around [asyncpg](https://github.com/MagicStack/asyncpg) ⭐ 7,998 | 🐛 269 | 🌐 Python | 📅 2026-02-27 for use with [SQLAlchemy Core](https://docs.sqlalchemy.org/en/latest/core/).
...
* [Beanie](https://github.com/BeanieODM/beanie) ⭐ 2,673 | 🐛 86 | 🌐 Python | 📅 2026-04-20 - Asynchronous Python ODM for MongoDB, based on [Motor](https://motor.readthedocs.io/en/stable/) and [Pydantic](https://docs.pydantic.dev/latest/), which supports data and schema migrations out of the box.
...
* [FastAPI Code Generator](https://github.com/koxudaxi/fastapi-code-generator) ⭐ 1,385 | 🐛 82 | 🌐 Python | 📅 2026-04-21 - Create a FastAPI app from an OpenAPI file, enabling schema-driven development.
...
* [Strawberry GraphQL](https://github.com/strawberry-graphql/strawberry) ⭐ 4,648 | 🐛 457 | 🌐 Python | 📅 2026-04-20 - Python GraphQL library based on dataclasses.
...
* [SlowApi](https://github.com/laurents/slowapi) ⭐ 1,955 | 🐛 101 | 🌐 Python | 📅 2026-04-18 - Rate limiter (based on [Flask-Limiter](https://flask-limiter.readthedocs.io)).
...
* [FastAPI Pagination](https://github.com/uriyyo/fastapi-pagination) ⭐ 1,645 | 🐛 7 | 🌐 Python | 📅 2026-04-21 - Pagination for FastAPI.
...
* [OpenTelemetry FastAPI Instrumentation](https://github.com/open-telemetry/opentelemetry-python-contrib/tree/main/instrumentation/opentelemetry-instrumentation-fastapi) ⭐ 1,031 | 🐛 667 | 🌐 Python | 📅 2026-04-20 - Library provides automatic and manual instrumentation of FastAPI web frameworks, instrumenting http requests served by applications utilizing the framework.
...
* [Source Code](https://github.com/fastapi/fastapi) ⭐ 97,453 | 🐛 176 | 🌐 Python | 📅 2026-04-20 - Hosted on GitHub.
...
* [FastAPI Best Practices](https://github.com/zhanymkanov/fastapi-best-practices) ⭐ 17,030 | 🐛 12 | 📅 2026-04-14 - Collection of best practices in a GitHub repo.
* [FastAPI Clean Example](https://github.com/ivan-borovets/fastapi-clean-example) ⭐ 536 | 🐛 0 | 🌐 Python | 📅 2026-04-17 - Clean Architecture backend example built with FastAPI.
* [FastAPI-Dishka-FastStream](https://github.com/faststream-community/fastapi-dishka-faststream) ⭐ 312 | 🐛 1 | 🌐 Python | 📅 2026-04-10 - Combines FastAPI, dishka, faststream, sqlalchemy, pydantic.
...
* [Full Stack FastAPI and PostgreSQL - Base Project Generator](https://github.com/fastapi/full-stack-fastapi-template) ⭐ 42,750 | 🐛 26 | 🌐 TypeScript | 📅 2026-04-20 - Full Stack FastAPI Template
...
* [Polar](https://github.com/polarsource/polar) ⭐ 9,676 | 🐛 355 | 🌐 Python | 📅 2026-04-20 - A funding and monetization platform for developers, built with FastAPI, SQLAlchemy, Alembic, and Arq.
...
* [Bitcart](https://github.com/bitcart/bitcart) ⭐ 928 | 🐛 41 | 🌐 Python | 📅 2026-04-20 - Platform for merchants, users and developers which offers easy setup and use.
...
* [FuturamaAPI](https://github.com/koldakov/futuramaapi) ⭐ 385 | 🐛 2 | 🌐 Python | 📅 2026-04-20 - A REST and GraphQL playground built with best practices, providing WebSockets, SSE, callbacks, secret messages, and more.
