...
# Awesome FastAPI | [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 452,661 | 🐛 60 | 📅 2026-04-02 with stars
...
* [FastAPI Admin](https://github.com/fastapi-admin/fastapi-admin) ⭐ 3,748 | 🐛 75 | 🌐 Python | 📅 2025-04-05 - Functional admin panel that provides a user interface for performing CRUD operations on your data. Currently only works with the Tortoise ORM.
* [SQLAlchemy Admin](https://github.com/aminalaee/sqladmin) ⭐ 2,702 | 🐛 104 | 🌐 Python | 📅 2026-04-05 - Admin Panel for FastAPI/Starlette that works with SQLAlchemy models.
* [FastAPI Amis Admin](https://github.com/amisadmin/fastapi-amis-admin) ⭐ 1,529 | 🐛 77 | 🌐 Python | 📅 2025-12-15 - A high-performance, efficient and easily extensible FastAPI admin framework.
* [Starlette Admin](https://github.com/jowilf/starlette-admin) ⭐ 983 | 🐛 95 | 🌐 Python | 📅 2026-04-06 - Admin framework for FastAPI/Starlette, supporting SQLAlchemy, SQLModel, MongoDB, and ODMantic.
...
* [FastAPI Users](https://github.com/fastapi-users/fastapi-users) ⭐ 6,068 | 🐛 5 | 🌐 Python | 📅 2026-03-30 - Account management, authentication, authorization.
* [AuthX](https://github.com/yezz123/AuthX) ⭐ 1,160 | 🐛 1 | 🌐 Python | 📅 2026-04-06 - Customizable Authentications and Oauth2 management for FastAPI.
...
* [FastAPI Guard](https://github.com/rennf93/fastapi-guard) ⭐ 725 | 🐛 1 | 🌐 Python | 📅 2026-03-26 - Rate Limiting, Automatically Ban IPs, Penetration Attack Detection, Whitelist/blacklist (countries, IPs, Cloud Providers), User Agent Filtering, Geolocation, Redis integration for persistence, and more.
...
* [Piccolo](https://github.com/piccolo-orm/piccolo) ⭐ 1,881 | 🐛 38 | 🌐 Python | 📅 2026-03-24 - An async ORM and query builder, supporting Postgres and SQLite, with batteries (migrations, security, etc).
...
* [Fastapi-SQLA](https://github.com/dialoguemd/fastapi-sqla) ⭐ 442 | 🐛 13 | 🌐 Python | 📅 2026-04-06 - SQLAlchemy extension for FastAPI with support for pagination, asyncio, and pytest.
...
* [FastAPIwee](https://github.com/Ignisor/FastAPIwee) ⭐ 106 | 🐛 1 | 🌐 Python | 📅 2021-07-09 - A simple way to create REST API based on [PeeWee](https://github.com/coleifer/peewee) ⭐ 11,959 | 🐛 1 | 🌐 Python | 📅 2026-04-02 models.
...
* [asyncpgsa](https://github.com/CanopyTax/asyncpgsa) ⭐ 510 | 🐛 14 | 🌐 Python | 📅 2024-02-17 - A wrapper around [asyncpg](https://github.com/MagicStack/asyncpg) ⭐ 7,994 | 🐛 267 | 🌐 Python | 📅 2026-02-27 for use with [SQLAlchemy Core](https://docs.sqlalchemy.org/en/latest/core/).
...
* [Beanie](https://github.com/BeanieODM/beanie) ⭐ 2,672 | 🐛 85 | 🌐 Python | 📅 2026-04-06 - Asynchronous Python ODM for MongoDB, based on [Motor](https://motor.readthedocs.io/en/stable/) and [Pydantic](https://docs.pydantic.dev/latest/), which supports data and schema migrations out of the box.
...
* [Wireup](https://github.com/maldoinc/wireup) ⭐ 381 | 🐛 19 | 🌐 Python | 📅 2026-04-05 - Inject dependencies with zero runtime overhead in FastAPI; Share dependencies across web, cli or other interfaces.
...
* [FastAPI MVC](https://github.com/fastapi-mvc/fastapi-mvc) ⭐ 796 | 🐛 32 | 🌐 Python | 📅 2026-04-01 - Developer productivity tool for making high-quality FastAPI production-ready APIs.
...
* [python-cqrs](https://github.com/pypatterns/python-cqrs) ⭐ 49 | 🐛 4 | 🌐 Python | 📅 2026-04-06 - Event-Driven Architecture Framework with CQRS, Transaction Outbox, Saga orchestration, seamless FastAPI/FastStream integration.
...
* [Strawberry GraphQL](https://github.com/strawberry-graphql/strawberry) ⭐ 4,641 | 🐛 448 | 🌐 Python | 📅 2026-04-06 - Python GraphQL library based on dataclasses.
...
* [SlowApi](https://github.com/laurents/slowapi) ⭐ 1,949 | 🐛 101 | 🌐 Python | 📅 2026-03-30 - Rate limiter (based on [Flask-Limiter](https://flask-limiter.readthedocs.io)).
...
* [FastAPI Pagination](https://github.com/uriyyo/fastapi-pagination) ⭐ 1,639 | 🐛 6 | 🌐 Python | 📅 2026-04-07 - Pagination for FastAPI.
...
* [OpenTelemetry FastAPI Instrumentation](https://github.com/open-telemetry/opentelemetry-python-contrib/tree/main/instrumentation/opentelemetry-instrumentation-fastapi) ⭐ 1,024 | 🐛 654 | 🌐 Python | 📅 2026-04-03 - Library provides automatic and manual instrumentation of FastAPI web frameworks, instrumenting http requests served by applications utilizing the framework.
...
* [Pydantic Resolve](https://github.com/allmonday/pydantic-resolve) ⭐ 318 | 🐛 5 | 🌐 Python | 📅 2026-04-07 -  Turns pydantic class into a powerful composable computing container by introducing resolve and post-process hooks.
* [FastAPI Cache](https://github.com/comeuplater/fastapi_cache) ⭐ 306 | 🐛 9 | 🌐 Python | 📅 2021-09-30 - A simple lightweight cache system.
* [FastAPI Injectable](https://github.com/JasperSui/fastapi-injectable) ⭐ 288 | 🐛 1 | 🌐 Python | 📅 2026-04-03 - Use FastAPI's dependency injection outside route handlers in CLI tools, background tasks, workers, and more.
...
* [Source Code](https://github.com/fastapi/fastapi) ⭐ 96,911 | 🐛 167 | 🌐 Python | 📅 2026-04-06 - Hosted on GitHub.
...
* [FastAPI Best Practices](https://github.com/zhanymkanov/fastapi-best-practices) ⭐ 16,928 | 🐛 12 | 📅 2026-01-10 - Collection of best practices in a GitHub repo.
* [FastAPI Clean Example](https://github.com/ivan-borovets/fastapi-clean-example) ⭐ 526 | 🐛 1 | 🌐 Python | 📅 2026-04-02 - Clean Architecture backend example built with FastAPI.
* [FastAPI-Dishka-FastStream](https://github.com/faststream-community/fastapi-dishka-faststream) ⭐ 309 | 🐛 0 | 🌐 Python | 📅 2026-04-06 - Combines FastAPI, dishka, faststream, sqlalchemy, pydantic.
...
* [Chalice](https://github.com/aws/chalice) ⭐ 11,047 | 🐛 495 | 🌐 Python | 📅 2025-05-29
...
* [Full Stack FastAPI and PostgreSQL - Base Project Generator](https://github.com/fastapi/full-stack-fastapi-template) ⭐ 42,498 | 🐛 20 | 🌐 TypeScript | 📅 2026-04-04 - Full Stack FastAPI Template
...
* [openapi-python-client](https://github.com/openapi-generators/openapi-python-client) ⭐ 1,932 | 🐛 99 | 🌐 Python | 📅 2026-03-16 - Generate modern FastAPI Python clients (via FastAPI) from OpenAPI.
...
* [Polar](https://github.com/polarsource/polar) ⭐ 9,633 | 🐛 348 | 🌐 Python | 📅 2026-04-07 - A funding and monetization platform for developers, built with FastAPI, SQLAlchemy, Alembic, and Arq.
...
* [FastAPI with Observability](https://github.com/Blueswen/fastapi-observability) ⭐ 1,083 | 🐛 6 | 🌐 Python | 📅 2025-05-11 - Observe FastAPI app with three pillars of observability: Traces (Tempo), Metrics (Prometheus), Logs (Loki) on Grafana through OpenTelemetry and OpenMetrics.
* [Bitcart](https://github.com/bitcart/bitcart) ⭐ 924 | 🐛 36 | 🌐 Python | 📅 2026-04-06 - Platform for merchants, users and developers which offers easy setup and use.
...
* [FuturamaAPI](https://github.com/koldakov/futuramaapi) ⭐ 380 | 🐛 3 | 🌐 Python | 📅 2026-03-11 - A REST and GraphQL playground built with best practices, providing WebSockets, SSE, callbacks, secret messages, and more.
...
* [Mailer](https://github.com/rclement/mailer) ⭐ 149 | 🐛 7 | 🌐 Python | 📅 2026-04-07 - Dead-simple mailer micro-service for static websites.
