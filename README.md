...
# Awesome FastAPI | [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 459,026 | 🐛 68 | 📅 2026-04-19 with stars
...
* [Starlette Admin](https://github.com/jowilf/starlette-admin) ⭐ 989 | 🐛 90 | 🌐 Python | 📅 2026-04-20 - Admin framework for FastAPI/Starlette, supporting SQLAlchemy, SQLModel, MongoDB, and ODMantic.
...
* [FastAPI Users](https://github.com/fastapi-users/fastapi-users) ⭐ 6,105 | 🐛 5 | 🌐 Python | 📅 2026-03-30 - Account management, authentication, authorization.
* [AuthX](https://github.com/yezz123/AuthX) ⭐ 1,169 | 🐛 2 | 🌐 Python | 📅 2026-04-26 - Customizable Authentications and Oauth2 management for FastAPI.
...
* [FastAPI Casbin Auth](https://github.com/officialpycasbin/fastapi-casbin-auth) ⭐ 22 | 🐛 6 | 🌐 Python | 📅 2026-04-14 - Authorization which supports various access control models like RBAC, ReBAC and ABAC through Casbin.

### CyberSecurity

* [FastAPI Guard](https://github.com/rennf93/fastapi-guard) ⭐ 730 | 🐛 1 | 🌐 Python | 📅 2026-04-25 - Rate Limiting, Automatically Ban IPs, Penetration Attack Detection, Whitelist/blacklist (countries, IPs, Cloud Providers), User Agent Filtering, Geolocation, Redis integration for persistence, and more.
...
* [asyncpgsa](https://github.com/CanopyTax/asyncpgsa) ⭐ 510 | 🐛 15 | 🌐 Python | 📅 2024-02-17 - A wrapper around [asyncpg](https://github.com/MagicStack/asyncpg) ⭐ 8,006 | 🐛 268 | 🌐 Python | 📅 2026-02-27 for use with [SQLAlchemy Core](https://docs.sqlalchemy.org/en/latest/core/).
...
* [Strawberry GraphQL](https://github.com/strawberry-graphql/strawberry) ⭐ 4,651 | 🐛 453 | 🌐 Python | 📅 2026-04-26 - Python GraphQL library based on dataclasses.
...
* [FastAPI Pagination](https://github.com/uriyyo/fastapi-pagination) ⭐ 1,645 | 🐛 7 | 🌐 Python | 📅 2026-04-24 - Pagination for FastAPI.
...
* [OpenTelemetry FastAPI Instrumentation](https://github.com/open-telemetry/opentelemetry-python-contrib/tree/main/instrumentation/opentelemetry-instrumentation-fastapi) ⭐ 1,033 | 🐛 667 | 🌐 Python | 📅 2026-04-24 - Library provides automatic and manual instrumentation of FastAPI web frameworks, instrumenting http requests served by applications utilizing the framework.
...
* [Pydantic Resolve](https://github.com/allmonday/pydantic-resolve) ⭐ 319 | 🐛 1 | 🌐 Python | 📅 2026-04-24 -  Turns pydantic class into a powerful composable computing container by introducing resolve and post-process hooks.
...
* [Source Code](https://github.com/fastapi/fastapi) ⭐ 97,651 | 🐛 174 | 🌐 Python | 📅 2026-04-26 - Hosted on GitHub.
...
* [FastAPI Best Practices](https://github.com/zhanymkanov/fastapi-best-practices) ⭐ 17,090 | 🐛 12 | 📅 2026-04-14 - Collection of best practices in a GitHub repo.
...
* [Full Stack FastAPI and PostgreSQL - Base Project Generator](https://github.com/fastapi/full-stack-fastapi-template) ⭐ 42,863 | 🐛 29 | 🌐 TypeScript | 📅 2026-04-21 - Full Stack FastAPI Template
...
* [openapi-python-client](https://github.com/openapi-generators/openapi-python-client) ⭐ 1,940 | 🐛 110 | 🌐 Python | 📅 2026-04-10 - Generate modern FastAPI Python clients (via FastAPI) from OpenAPI.
...
* [Polar](https://github.com/polarsource/polar) ⭐ 9,767 | 🐛 83 | 🌐 Python | 📅 2026-04-25 - A funding and monetization platform for developers, built with FastAPI, SQLAlchemy, Alembic, and Arq.
...
* [Bitcart](https://github.com/bitcart/bitcart) ⭐ 930 | 🐛 42 | 🌐 Python | 📅 2026-04-22 - Platform for merchants, users and developers which offers easy setup and use.
...
* [FuturamaAPI](https://github.com/koldakov/futuramaapi) ⭐ 387 | 🐛 3 | 🌐 Python | 📅 2026-04-20 - A REST and GraphQL playground built with best practices, providing WebSockets, SSE, callbacks, secret messages, and more.
