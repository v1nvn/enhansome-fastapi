...
# Awesome FastAPI | [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 453,361 | 🐛 59 | 📅 2026-04-02 with stars
...
* [SQLAlchemy Admin](https://github.com/aminalaee/sqladmin) ⭐ 2,702 | 🐛 102 | 🌐 Python | 📅 2026-04-05 - Admin Panel for FastAPI/Starlette that works with SQLAlchemy models.
...
* [AuthX](https://github.com/yezz123/AuthX) ⭐ 1,160 | 🐛 3 | 🌐 Python | 📅 2026-04-08 - Customizable Authentications and Oauth2 management for FastAPI.
...
* [FastAPI Casbin Auth](https://github.com/officialpycasbin/fastapi-casbin-auth) ⭐ 21 | 🐛 5 | 🌐 Python | 📅 2026-04-08 - Authorization which supports various access control models like RBAC, ReBAC and ABAC through Casbin.
...
* [Tortoise ORM](https://tortoise.github.io) - An easy-to-use asyncio ORM (Object Relational Mapper) inspired by Django.
  * [Aerich](https://github.com/tortoise/aerich) ⭐ 1,089 | 🐛 28 | 🌐 Python | 📅 2026-04-08 - Tortoise ORM migrations tools.
...
* [Fastapi-SQLA](https://github.com/dialoguemd/fastapi-sqla) ⭐ 442 | 🐛 13 | 🌐 Python | 📅 2026-04-08 - SQLAlchemy extension for FastAPI with support for pagination, asyncio, and pytest.
...
* [PyPika](https://github.com/kayak/pypika) ⭐ 2,901 | 🐛 231 | 🌐 Python | 📅 2026-02-04 - A SQL query builder that exposes the full richness of the SQL language.
* [asyncpgsa](https://github.com/CanopyTax/asyncpgsa) ⭐ 509 | 🐛 15 | 🌐 Python | 📅 2024-02-17 - A wrapper around [asyncpg](https://github.com/MagicStack/asyncpg) ⭐ 7,995 | 🐛 268 | 🌐 Python | 📅 2026-02-27 for use with [SQLAlchemy Core](https://docs.sqlalchemy.org/en/latest/core/).

#### ODMs

* [MongoEngine](https://github.com/MongoEngine/mongoengine) ⭐ 4,351 | 🐛 349 | 🌐 Python | 📅 2026-03-10 - A Document-Object Mapper (think ORM, but for document databases) for working with MongoDB from Python.
* [Beanie](https://github.com/BeanieODM/beanie) ⭐ 2,673 | 🐛 86 | 🌐 Python | 📅 2026-04-06 - Asynchronous Python ODM for MongoDB, based on [Motor](https://motor.readthedocs.io/en/stable/) and [Pydantic](https://docs.pydantic.dev/latest/), which supports data and schema migrations out of the box.
...
* [Wireup](https://github.com/maldoinc/wireup) ⭐ 382 | 🐛 20 | 🌐 Python | 📅 2026-04-05 - Inject dependencies with zero runtime overhead in FastAPI; Share dependencies across web, cli or other interfaces.
...
* [FastAPI Code Generator](https://github.com/koxudaxi/fastapi-code-generator) ⭐ 1,382 | 🐛 79 | 🌐 Python | 📅 2026-03-16 - Create a FastAPI app from an OpenAPI file, enabling schema-driven development.
...
* [Strawberry GraphQL](https://github.com/strawberry-graphql/strawberry) ⭐ 4,640 | 🐛 445 | 🌐 Python | 📅 2026-04-08 - Python GraphQL library based on dataclasses.
* [FastAPI Utilities](https://github.com/fastapiutils/fastapi-utils) ⭐ 2,305 | 🐛 65 | 🌐 Python | 📅 2025-03-03 - Reusable utilities: class-based views, response inferring router, periodic tasks, timing middleware, SQLAlchemy session, OpenAPI spec simplification.
...
* [FastAPI Pagination](https://github.com/uriyyo/fastapi-pagination) ⭐ 1,641 | 🐛 8 | 🌐 Python | 📅 2026-04-08 - Pagination for FastAPI.
...
* [OpenTelemetry FastAPI Instrumentation](https://github.com/open-telemetry/opentelemetry-python-contrib/tree/main/instrumentation/opentelemetry-instrumentation-fastapi) ⭐ 1,026 | 🐛 656 | 🌐 Python | 📅 2026-04-08 - Library provides automatic and manual instrumentation of FastAPI web frameworks, instrumenting http requests served by applications utilizing the framework.
...
* [FastAPI Injectable](https://github.com/JasperSui/fastapi-injectable) ⭐ 289 | 🐛 1 | 🌐 Python | 📅 2026-04-03 - Use FastAPI's dependency injection outside route handlers in CLI tools, background tasks, workers, and more.
...
* [Apitally](https://github.com/apitally/apitally-py) ⭐ 218 | 🐛 3 | 🌐 Python | 📅 2026-04-08 - API analytics, monitoring, and request logging for FastAPI.
...
* [Source Code](https://github.com/fastapi/fastapi) ⭐ 96,984 | 🐛 167 | 🌐 Python | 📅 2026-04-08 - Hosted on GitHub.
...
* [FastAPI Best Practices](https://github.com/zhanymkanov/fastapi-best-practices) ⭐ 16,944 | 🐛 12 | 📅 2026-01-10 - Collection of best practices in a GitHub repo.
* [FastAPI Clean Example](https://github.com/ivan-borovets/fastapi-clean-example) ⭐ 528 | 🐛 1 | 🌐 Python | 📅 2026-04-02 - Clean Architecture backend example built with FastAPI.
...
* [Full Stack FastAPI and PostgreSQL - Base Project Generator](https://github.com/fastapi/full-stack-fastapi-template) ⭐ 42,535 | 🐛 20 | 🌐 TypeScript | 📅 2026-04-04 - Full Stack FastAPI Template
...
* [openapi-python-client](https://github.com/openapi-generators/openapi-python-client) ⭐ 1,930 | 🐛 101 | 🌐 Python | 📅 2026-04-08 - Generate modern FastAPI Python clients (via FastAPI) from OpenAPI.
...
* [Polar](https://github.com/polarsource/polar) ⭐ 9,637 | 🐛 366 | 🌐 Python | 📅 2026-04-08 - A funding and monetization platform for developers, built with FastAPI, SQLAlchemy, Alembic, and Arq.
...
* [Awesome FastAPI Projects](https://github.com/Kludex/awesome-fastapi-projects) ⭐ 1,598 | 🐛 12 | 🌐 TypeScript | 📅 2026-03-30 - Organized list of projects that use FastAPI.
...
* [Bitcart](https://github.com/bitcart/bitcart) ⭐ 925 | 🐛 37 | 🌐 Python | 📅 2026-04-07 - Platform for merchants, users and developers which offers easy setup and use.
...
* [Mailer](https://github.com/rclement/mailer) ⭐ 149 | 🐛 10 | 🌐 Python | 📅 2026-04-09 - Dead-simple mailer micro-service for static websites.
