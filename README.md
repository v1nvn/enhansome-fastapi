...
# Awesome FastAPI | [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 438,407 | 🐛 71 | 📅 2026-01-28 with stars
...
* [FastAPI Admin](https://github.com/fastapi-admin/fastapi-admin) ⭐ 3,710 | 🐛 74 | 🌐 Python | 📅 2025-04-05 - Functional admin panel that provides a user interface for performing CRUD operations on your data. Currently only works with the Tortoise ORM.
* [SQLAlchemy Admin](https://github.com/aminalaee/sqladmin) ⭐ 2,660 | 🐛 104 | 🌐 Python | 📅 2026-02-10 - Admin Panel for FastAPI/Starlette that works with SQLAlchemy models.
...
* [FastAPI Users](https://github.com/fastapi-users/fastapi-users) ⭐ 6,004 | 🐛 4 | 🌐 Python | 📅 2026-02-05 - Account management, authentication, authorization.
* [AuthX](https://github.com/yezz123/AuthX) ⭐ 1,144 | 🐛 1 | 🌐 Python | 📅 2026-02-16 - Customizable Authentications and Oauth2 management for FastAPI.
...
* [Piccolo](https://github.com/piccolo-orm/piccolo) ⭐ 1,857 | 🐛 55 | 🌐 Python | 📅 2026-02-12 - An async ORM and query builder, supporting Postgres and SQLite, with batteries (migrations, security, etc).
...
* [Fastapi-SQLA](https://github.com/dialoguemd/fastapi-sqla) ⭐ 436 | 🐛 13 | 🌐 Python | 📅 2026-02-18 - SQLAlchemy extension for FastAPI with support for pagination, asyncio, and pytest.
...
* [FastAPIwee](https://github.com/Ignisor/FastAPIwee) ⭐ 108 | 🐛 1 | 🌐 Python | 📅 2021-07-09 - A simple way to create REST API based on [PeeWee](https://github.com/coleifer/peewee) ⭐ 11,939 | 🐛 0 | 🌐 Python | 📅 2026-02-16 models.
...
* [asyncpgsa](https://github.com/CanopyTax/asyncpgsa) ⭐ 511 | 🐛 14 | 🌐 Python | 📅 2024-02-17 - A wrapper around [asyncpg](https://github.com/MagicStack/asyncpg) ⭐ 7,949 | 🐛 263 | 🌐 Python | 📅 2025-11-24 for use with [SQLAlchemy Core](https://docs.sqlalchemy.org/en/latest/core/).

#### ODMs

* [PynamoDB](https://github.com/pynamodb/PynamoDB) ⭐ 2,647 | 🐛 317 | 🌐 Python | 📅 2026-01-06 - A pythonic interface to Amazon's DynamoDB.
* [Beanie](https://github.com/BeanieODM/beanie) ⭐ 2,644 | 🐛 112 | 🌐 Python | 📅 2026-02-18 - Asynchronous Python ODM for MongoDB, based on [Motor](https://motor.readthedocs.io/en/stable/) and [Pydantic](https://docs.pydantic.dev/latest/), which supports data and schema migrations out of the box.
...
* [Manage FastAPI](https://github.com/ycd/manage-fastapi) ⭐ 1,895 | 🐛 22 | 🌐 Python | 📅 2024-03-01 - CLI tool for generating and managing FastAPI projects.
...
* [FastAPI MVC](https://github.com/fastapi-mvc/fastapi-mvc) ⭐ 787 | 🐛 23 | 🌐 Python | 📅 2026-02-11 - Developer productivity tool for making high-quality FastAPI production-ready APIs.
...
* [Strawberry GraphQL](https://github.com/strawberry-graphql/strawberry) ⭐ 4,605 | 🐛 465 | 🌐 Python | 📅 2026-02-18 - Python GraphQL library based on dataclasses.
...
* [SlowApi](https://github.com/laurents/slowapi) ⭐ 1,914 | 🐛 93 | 🌐 Python | 📅 2025-08-10 - Rate limiter (based on [Flask-Limiter](https://flask-limiter.readthedocs.io)).
* [FastAPI Cache](https://github.com/long2ice/fastapi-cache) ⭐ 1,826 | 🐛 104 | 🌐 Python | 📅 2025-06-30 - A tool to cache FastAPI response and function results, with support for Redis, Memcached, DynamoDB, and in-memory backends.
* [FastAPI Pagination](https://github.com/uriyyo/fastapi-pagination) ⭐ 1,623 | 🐛 6 | 🌐 Python | 📅 2026-02-19 - Pagination for FastAPI.
...
* [OpenTelemetry FastAPI Instrumentation](https://github.com/open-telemetry/opentelemetry-python-contrib/tree/main/instrumentation/opentelemetry-instrumentation-fastapi) ⭐ 993 | 🐛 797 | 🌐 Python | 📅 2026-02-16 - Library provides automatic and manual instrumentation of FastAPI web frameworks, instrumenting http requests served by applications utilizing the framework.
...
* [FastAPI Injectable](https://github.com/JasperSui/fastapi-injectable) ⭐ 283 | 🐛 1 | 🌐 Python | 📅 2026-02-16 - Use FastAPI's dependency injection outside route handlers in CLI tools, background tasks, workers, and more.
...
* [Source Code](https://github.com/fastapi/fastapi) ⭐ 95,269 | 🐛 141 | 🌐 Python | 📅 2026-02-18 - Hosted on GitHub.
...
* [FastAPI Best Practices](https://github.com/zhanymkanov/fastapi-best-practices) ⭐ 16,507 | 🐛 9 | 📅 2026-01-10 - Collection of best practices in a GitHub repo.
...
* [Chalice](https://github.com/aws/chalice) ⭐ 11,062 | 🐛 493 | 🌐 Python | 📅 2025-05-29
...
* [Full Stack FastAPI and PostgreSQL - Base Project Generator](https://github.com/fastapi/full-stack-fastapi-template) ⭐ 41,608 | 🐛 9 | 🌐 TypeScript | 📅 2026-02-16 - Full Stack FastAPI Template
...
* [openapi-python-client](https://github.com/openapi-generators/openapi-python-client) ⭐ 1,908 | 🐛 93 | 🌐 Python | 📅 2026-02-17 - Generate modern FastAPI Python clients (via FastAPI) from OpenAPI.
...
* [uvicorn-gunicorn-fastapi-docker](https://github.com/tiangolo/uvicorn-gunicorn-fastapi-docker) ⭐ 2,908 | 🐛 5 | 🌐 Python | 📅 2026-02-17 - Docker image with Uvicorn managed by Gunicorn for high-performance FastAPI web applications in Python 3.7 and 3.6 with performance auto-tuning.
* [inboard](https://github.com/br3ndonland/inboard) ⭐ 317 | 🐛 0 | 🌐 Python | 📅 2026-02-19 - Docker images to power your FastAPI apps and help you ship faster.
...
* [Polar](https://github.com/polarsource/polar) ⭐ 9,446 | 🐛 321 | 🌐 Python | 📅 2026-02-18 - A funding and monetization platform for developers, built with FastAPI, SQLAlchemy, Alembic, and Arq.
...
* [FastAPI with Observability](https://github.com/Blueswen/fastapi-observability) ⭐ 1,071 | 🐛 6 | 🌐 Python | 📅 2025-05-11 - Observe FastAPI app with three pillars of observability: Traces (Tempo), Metrics (Prometheus), Logs (Loki) on Grafana through OpenTelemetry and OpenMetrics.
* [Bitcart](https://github.com/bitcart/bitcart) ⭐ 892 | 🐛 28 | 🌐 Python | 📅 2026-02-19 - Platform for merchants, users and developers which offers easy setup and use.
...
* [Mailer](https://github.com/rclement/mailer) ⭐ 151 | 🐛 0 | 🌐 Python | 📅 2026-02-18 - Dead-simple mailer micro-service for static websites.
