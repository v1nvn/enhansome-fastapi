...
# Awesome FastAPI | [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 454,669 | 🐛 62 | 📅 2026-04-02 with stars
...
* [SQLAlchemy Admin](https://github.com/aminalaee/sqladmin) ⭐ 2,703 | 🐛 98 | 🌐 Python | 📅 2026-04-10 - Admin Panel for FastAPI/Starlette that works with SQLAlchemy models.
...
* [AuthX](https://github.com/yezz123/AuthX) ⭐ 1,163 | 🐛 4 | 🌐 Python | 📅 2026-04-08 - Customizable Authentications and Oauth2 management for FastAPI.
...
* [FastAPI Guard](https://github.com/rennf93/fastapi-guard) ⭐ 728 | 🐛 1 | 🌐 Python | 📅 2026-04-09 - Rate Limiting, Automatically Ban IPs, Penetration Attack Detection, Whitelist/blacklist (countries, IPs, Cloud Providers), User Agent Filtering, Geolocation, Redis integration for persistence, and more.
...
* [Piccolo](https://github.com/piccolo-orm/piccolo) ⭐ 1,884 | 🐛 38 | 🌐 Python | 📅 2026-03-24 - An async ORM and query builder, supporting Postgres and SQLite, with batteries (migrations, security, etc).
...
* [Fastapi-SQLA](https://github.com/dialoguemd/fastapi-sqla) ⭐ 443 | 🐛 14 | 🌐 Python | 📅 2026-04-13 - SQLAlchemy extension for FastAPI with support for pagination, asyncio, and pytest.
...
* [PyPika](https://github.com/kayak/pypika) ⭐ 2,901 | 🐛 230 | 🌐 Python | 📅 2026-02-04 - A SQL query builder that exposes the full richness of the SQL language.
...
* [PynamoDB](https://github.com/pynamodb/PynamoDB) ⭐ 2,648 | 🐛 318 | 🌐 Python | 📅 2026-01-06 - A pythonic interface to Amazon's DynamoDB.
...
* [Wireup](https://github.com/maldoinc/wireup) ⭐ 384 | 🐛 17 | 🌐 Python | 📅 2026-04-12 - Inject dependencies with zero runtime overhead in FastAPI; Share dependencies across web, cli or other interfaces.
...
* [FastAPI Mail](https://github.com/sabuhish/fastapi-mail) ⭐ 990 | 🐛 27 | 🌐 Python | 📅 2026-03-06 - Lightweight mail system for sending emails and attachments (individual and bulk).

### Utils

* [Strawberry GraphQL](https://github.com/strawberry-graphql/strawberry) ⭐ 4,644 | 🐛 451 | 🌐 Python | 📅 2026-04-12 - Python GraphQL library based on dataclasses.
...
* [Prometheus FastAPI Instrumentator](https://github.com/trallnag/prometheus-fastapi-instrumentator) ⭐ 1,441 | 🐛 67 | 🌐 Python | 📅 2025-10-01 - A configurable and modular Prometheus Instrumentator for your FastAPI application.
* [OpenTelemetry FastAPI Instrumentation](https://github.com/open-telemetry/opentelemetry-python-contrib/tree/main/instrumentation/opentelemetry-instrumentation-fastapi) ⭐ 1,027 | 🐛 655 | 🌐 Python | 📅 2026-04-10 - Library provides automatic and manual instrumentation of FastAPI web frameworks, instrumenting http requests served by applications utilizing the framework.
* [FastAPI Limiter](https://github.com/long2ice/fastapi-limiter) ⭐ 764 | 🐛 29 | 🌐 Python | 📅 2026-02-06 - A request rate limiter for FastAPI.
...
* [Pydantic Resolve](https://github.com/allmonday/pydantic-resolve) ⭐ 319 | 🐛 2 | 🌐 Python | 📅 2026-04-12 -  Turns pydantic class into a powerful composable computing container by introducing resolve and post-process hooks.
...
* [Source Code](https://github.com/fastapi/fastapi) ⭐ 97,126 | 🐛 172 | 🌐 Python | 📅 2026-04-10 - Hosted on GitHub.
...
* [FastAPI Best Practices](https://github.com/zhanymkanov/fastapi-best-practices) ⭐ 16,974 | 🐛 12 | 📅 2026-01-10 - Collection of best practices in a GitHub repo.
...
* [FastAPI-Dishka-FastStream](https://github.com/faststream-community/fastapi-dishka-faststream) ⭐ 312 | 🐛 0 | 🌐 Python | 📅 2026-04-10 - Combines FastAPI, dishka, faststream, sqlalchemy, pydantic.
...
* [Full Stack FastAPI and PostgreSQL - Base Project Generator](https://github.com/fastapi/full-stack-fastapi-template) ⭐ 42,602 | 🐛 22 | 🌐 TypeScript | 📅 2026-04-12 - Full Stack FastAPI Template
...
* [openapi-python-client](https://github.com/openapi-generators/openapi-python-client) ⭐ 1,933 | 🐛 103 | 🌐 Python | 📅 2026-04-10 - Generate modern FastAPI Python clients (via FastAPI) from OpenAPI.
...
* [Polar](https://github.com/polarsource/polar) ⭐ 9,643 | 🐛 354 | 🌐 Python | 📅 2026-04-12 - A funding and monetization platform for developers, built with FastAPI, SQLAlchemy, Alembic, and Arq.
...
* [FastAPI with Observability](https://github.com/Blueswen/fastapi-observability) ⭐ 1,085 | 🐛 6 | 🌐 Python | 📅 2026-04-12 - Observe FastAPI app with three pillars of observability: Traces (Tempo), Metrics (Prometheus), Logs (Loki) on Grafana through OpenTelemetry and OpenMetrics.
* [Bitcart](https://github.com/bitcart/bitcart) ⭐ 923 | 🐛 39 | 🌐 Python | 📅 2026-04-13 - Platform for merchants, users and developers which offers easy setup and use.
