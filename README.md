...
# Awesome FastAPI | [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 438,982 | 🐛 70 | 📅 2026-01-28 with stars
...
* [FastAPI Admin](https://github.com/fastapi-admin/fastapi-admin) ⭐ 3,713 | 🐛 74 | 🌐 Python | 📅 2025-04-05 - Functional admin panel that provides a user interface for performing CRUD operations on your data. Currently only works with the Tortoise ORM.
* [SQLAlchemy Admin](https://github.com/aminalaee/sqladmin) ⭐ 2,663 | 🐛 104 | 🌐 Python | 📅 2026-02-10 - Admin Panel for FastAPI/Starlette that works with SQLAlchemy models.
* [FastAPI Amis Admin](https://github.com/amisadmin/fastapi-amis-admin) ⭐ 1,518 | 🐛 77 | 🌐 Python | 📅 2025-12-15 - A high-performance, efficient and easily extensible FastAPI admin framework.
* [Starlette Admin](https://github.com/jowilf/starlette-admin) ⭐ 980 | 🐛 95 | 🌐 Python | 📅 2026-02-16 - Admin framework for FastAPI/Starlette, supporting SQLAlchemy, SQLModel, MongoDB, and ODMantic.
* [Piccolo Admin](https://github.com/piccolo-orm/piccolo_admin) ⭐ 467 | 🐛 45 | 🌐 Python | 📅 2026-01-31 - A powerful and modern admin GUI, using the Piccolo ORM.

### Auth

* [FastAPI Users](https://github.com/fastapi-users/fastapi-users) ⭐ 6,008 | 🐛 4 | 🌐 Python | 📅 2026-02-05 - Account management, authentication, authorization.
* [AuthX](https://github.com/yezz123/AuthX) ⭐ 1,144 | 🐛 1 | 🌐 Python | 📅 2026-02-19 - Customizable Authentications and Oauth2 management for FastAPI.
...
* [FastAPI Login](https://github.com/maxrdu/fastapi_login) ⭐ 824 | 🐛 1 | 🌐 Python | 📅 2025-05-20 - Account management and authentication (based on [Flask-Login](https://github.com/maxcountryman/flask-login) ⭐ 3,681 | 🐛 20 | 🌐 Python | 📅 2025-08-27).
...
* [FastAPI Permissions](https://github.com/holgi/fastapi-permissions) ⭐ 652 | 🐛 18 | 🌐 Python | 📅 2023-10-16 - Row-level permissions.
...
* [Piccolo](https://github.com/piccolo-orm/piccolo) ⭐ 1,860 | 🐛 56 | 🌐 Python | 📅 2026-02-12 - An async ORM and query builder, supporting Postgres and SQLite, with batteries (migrations, security, etc).
...
* [Tortoise ORM](https://tortoise.github.io) - An easy-to-use asyncio ORM (Object Relational Mapper) inspired by Django.
  * [Aerich](https://github.com/tortoise/aerich) ⭐ 1,090 | 🐛 24 | 🌐 Python | 📅 2026-02-11 - Tortoise ORM migrations tools.
...
* [Fastapi-SQLA](https://github.com/dialoguemd/fastapi-sqla) ⭐ 436 | 🐛 14 | 🌐 Python | 📅 2026-02-20 - SQLAlchemy extension for FastAPI with support for pagination, asyncio, and pytest.
* [Edgy ORM](https://github.com/dymmond/edgy) ⭐ 422 | 🐛 1 | 🌐 Python | 📅 2026-02-15 - Complex databases made simple.
* [Saffier ORM](https://github.com/tarsil/saffier) ⭐ 152 | 🐛 10 | 🌐 Python | 📅 2026-01-26 - The only Python ORM you will ever need.
* [FastAPIwee](https://github.com/Ignisor/FastAPIwee) ⭐ 108 | 🐛 1 | 🌐 Python | 📅 2021-07-09 - A simple way to create REST API based on [PeeWee](https://github.com/coleifer/peewee) ⭐ 11,940 | 🐛 0 | 🌐 Python | 📅 2026-02-21 models.
...
* [PyPika](https://github.com/kayak/pypika) ⭐ 2,889 | 🐛 229 | 🌐 Python | 📅 2026-02-04 - A SQL query builder that exposes the full richness of the SQL language.
* [asyncpgsa](https://github.com/CanopyTax/asyncpgsa) ⭐ 511 | 🐛 14 | 🌐 Python | 📅 2024-02-17 - A wrapper around [asyncpg](https://github.com/MagicStack/asyncpg) ⭐ 7,950 | 🐛 263 | 🌐 Python | 📅 2025-11-24 for use with [SQLAlchemy Core](https://docs.sqlalchemy.org/en/latest/core/).

#### ODMs

* [PynamoDB](https://github.com/pynamodb/PynamoDB) ⭐ 2,648 | 🐛 317 | 🌐 Python | 📅 2026-01-06 - A pythonic interface to Amazon's DynamoDB.
* [Beanie](https://github.com/BeanieODM/beanie) ⭐ 2,646 | 🐛 110 | 🌐 Python | 📅 2026-02-20 - Asynchronous Python ODM for MongoDB, based on [Motor](https://motor.readthedocs.io/en/stable/) and [Pydantic](https://docs.pydantic.dev/latest/), which supports data and schema migrations out of the box.
...
* [Wireup](https://github.com/maldoinc/wireup) ⭐ 353 | 🐛 15 | 🌐 Python | 📅 2026-02-09 - Inject dependencies with zero runtime overhead in FastAPI; Share dependencies across web, cli or other interfaces.

### Developer Tools

* [Manage FastAPI](https://github.com/ycd/manage-fastapi) ⭐ 1,896 | 🐛 22 | 🌐 Python | 📅 2024-03-01 - CLI tool for generating and managing FastAPI projects.
...
* [FastAPI MVC](https://github.com/fastapi-mvc/fastapi-mvc) ⭐ 789 | 🐛 24 | 🌐 Python | 📅 2026-02-19 - Developer productivity tool for making high-quality FastAPI production-ready APIs.
...
* [FastAPI Profiler](https://github.com/sunhailin-Leo/fastapi_profiler) ⭐ 365 | 🐛 1 | 🌐 Python | 📅 2024-05-17 - A FastAPI Middleware of joerick/pyinstrument to check your service performance.
...
* [FastAPI Mail](https://github.com/sabuhish/fastapi-mail) ⭐ 974 | 🐛 19 | 🌐 Python | 📅 2026-02-17 - Lightweight mail system for sending emails and attachments (individual and bulk).

### Utils

* [Strawberry GraphQL](https://github.com/strawberry-graphql/strawberry) ⭐ 4,608 | 🐛 459 | 🌐 Python | 📅 2026-02-20 - Python GraphQL library based on dataclasses.
* [FastAPI Utilities](https://github.com/fastapiutils/fastapi-utils) ⭐ 2,303 | 🐛 65 | 🌐 Python | 📅 2025-03-03 - Reusable utilities: class-based views, response inferring router, periodic tasks, timing middleware, SQLAlchemy session, OpenAPI spec simplification.
* [SlowApi](https://github.com/laurents/slowapi) ⭐ 1,916 | 🐛 93 | 🌐 Python | 📅 2025-08-10 - Rate limiter (based on [Flask-Limiter](https://flask-limiter.readthedocs.io)).
* [FastAPI Cache](https://github.com/long2ice/fastapi-cache) ⭐ 1,827 | 🐛 104 | 🌐 Python | 📅 2025-06-30 - A tool to cache FastAPI response and function results, with support for Redis, Memcached, DynamoDB, and in-memory backends.
* [FastAPI Pagination](https://github.com/uriyyo/fastapi-pagination) ⭐ 1,625 | 🐛 6 | 🌐 Python | 📅 2026-02-20 - Pagination for FastAPI.
* [FastAPI FastCRUD](https://github.com/benavlabs/fastcrud) ⭐ 1,482 | 🐛 21 | 🌐 Python | 📅 2026-01-27) - Robust async CRUD operations and flexible endpoint creation utilities.
* [Prometheus FastAPI Instrumentator](https://github.com/trallnag/prometheus-fastapi-instrumentator) ⭐ 1,428 | 🐛 66 | 🌐 Python | 📅 2025-10-01 - A configurable and modular Prometheus Instrumentator for your FastAPI application.
* [OpenTelemetry FastAPI Instrumentation](https://github.com/open-telemetry/opentelemetry-python-contrib/tree/main/instrumentation/opentelemetry-instrumentation-fastapi) ⭐ 993 | 🐛 799 | 🌐 Python | 📅 2026-02-20 - Library provides automatic and manual instrumentation of FastAPI web frameworks, instrumenting http requests served by applications utilizing the framework.
* [FastAPI Contrib](https://github.com/identixone/fastapi_contrib) ⭐ 747 | 🐛 15 | 🌐 Python | 📅 2022-09-12 - Opinionated set of utilities: pagination, auth middleware, permissions, custom exception handlers, MongoDB support, and Opentracing middleware.
* [FastAPI Limiter](https://github.com/long2ice/fastapi-limiter) ⭐ 742 | 🐛 27 | 🌐 Python | 📅 2026-02-06 - A request rate limiter for FastAPI.
* [ASGI Correlation ID](https://github.com/snok/asgi-correlation-id) ⭐ 631 | 🐛 4 | 🌐 Python | 📅 2024-10-17 - Request ID logging middleware.
* [FastAPI Plugins](https://github.com/madkote/fastapi-plugins) ⭐ 613 | 🐛 3 | 🌐 Python | 📅 2025-07-09 - Redis and Scheduler plugins.
...
* [Starlette Context](https://github.com/tomwojcik/starlette-context) ⭐ 610 | 🐛 27 | 🌐 Python | 📅 2026-01-19 - Allows you to store and access the request data anywhere in your project, useful for logging.
...
* [FastAPI MQTT](https://github.com/sabuhish/fastapi-mqtt) ⭐ 380 | 🐛 5 | 🌐 Python | 📅 2024-05-22 - An extension for the MQTT protocol.
...
* [FastAPI Injectable](https://github.com/JasperSui/fastapi-injectable) ⭐ 284 | 🐛 1 | 🌐 Python | 📅 2026-02-16 - Use FastAPI's dependency injection outside route handlers in CLI tools, background tasks, workers, and more.
* [FastAPI Chameleon](https://github.com/mikeckennedy/fastapi-chameleon) ⭐ 230 | 🐛 1 | 🌐 Python | 📅 2025-04-04 - Adds integration of the Chameleon template language to FastAPI.
* [Apitally](https://github.com/apitally/apitally-py) ⭐ 217 | 🐛 1 | 🌐 Python | 📅 2026-02-21 - API analytics, monitoring, and request logging for FastAPI.
...
* [FastAPI Listing](https://github.com/danielhasan1/fastapi-listing) ⭐ 142 | 🐛 6 | 🌐 Python | 📅 2025-02-28 - A library to design/build listing APIs using component-based architecture, inbuilt query paginator, sorter, django-admin like filters & much more.
...
* [Source Code](https://github.com/fastapi/fastapi) ⭐ 95,391 | 🐛 148 | 🌐 Python | 📅 2026-02-20 - Hosted on GitHub.
...
* [FastAPI Best Practices](https://github.com/zhanymkanov/fastapi-best-practices) ⭐ 16,518 | 🐛 9 | 📅 2026-01-10 - Collection of best practices in a GitHub repo.
* [FastAPI-Dishka-FastStream](https://github.com/faststream-community/fastapi-dishka-faststream) ⭐ 300 | 🐛 0 | 🌐 Python | 📅 2026-01-03 - Combines FastAPI, dishka, faststream, sqlalchemy, pydantic.
...
* [Fly](https://fly.io) ([tutorial](https://fly.io/docs/python/frameworks/fastapi/), [Deploy from a Git repo](https://github.com/fly-apps/hello-fastapi) ⭐ 16 | 🐛 2 | 🌐 Python | 📅 2024-07-31)
...
* [Chalice](https://github.com/aws/chalice) ⭐ 11,060 | 🐛 494 | 🌐 Python | 📅 2025-05-29
* [Vercel](https://vercel.com/) - (formerly Zeit) ([example](https://github.com/Snailedlt/Markdown-Videos) ⭐ 178 | 🐛 28 | 🌐 Python | 📅 2025-11-21).
...
* [Full Stack FastAPI and PostgreSQL - Base Project Generator](https://github.com/fastapi/full-stack-fastapi-template) ⭐ 41,642 | 🐛 8 | 🌐 TypeScript | 📅 2026-02-16 - Full Stack FastAPI Template
...
* [FastAPI template](https://github.com/s3rius/FastAPI-template) ⭐ 2,741 | 🐛 39 | 🌐 Python | 📅 2025-11-28 - Flexible, lightweight FastAPI project generator. It includes support for SQLAlchemy, multiple databases, CI/CD, Docker, and Kubernetes.
...
* [openapi-python-client](https://github.com/openapi-generators/openapi-python-client) ⭐ 1,910 | 🐛 94 | 🌐 Python | 📅 2026-02-17 - Generate modern FastAPI Python clients (via FastAPI) from OpenAPI.
...
* [cookiecutter-fastapi](https://github.com/arthurhenrique/cookiecutter-fastapi) ⭐ 704 | 🐛 1 | 🌐 Python | 📅 2025-08-25 - Cookiecutter template for FastAPI projects using: Machine Learning, Poetry, Azure Pipelines and pytest.
* [cookiecutter-spacy-fastapi](https://github.com/microsoft/cookiecutter-spacy-fastapi) ⭐ 622 | 🐛 6 | 🌐 Python | 📅 2022-11-28 - Quick deployments of spaCy models with FastAPI.
* [FastAPI Model Server Skeleton](https://github.com/eightBEC/fastapi-ml-skeleton) ⭐ 599 | 🐛 8 | 🌐 Python | 📅 2026-01-08 - Skeleton app to serve machine learning models production-ready.
...
* [FastAPI and Tortoise ORM](https://github.com/prostomarkeloff/fastapi-tortoise) ⭐ 224 | 🐛 0 | 🌐 Python | 📅 2024-06-27 - Powerful but simple template for web APIs w/ FastAPI (as web framework) and Tortoise-ORM (for working via database without headache).
...
* [FastAPI with Firestore](https://github.com/anthonycorletti/firestore-fastapi) ⭐ 136 | 🐛 2 | 🌐 Python | 📅 2024-10-07 - Boilerplate for API building with FastAPI and Google Cloud Firestore.
...
* [uvicorn-gunicorn-fastapi-docker](https://github.com/tiangolo/uvicorn-gunicorn-fastapi-docker) ⭐ 2,909 | 🐛 5 | 🌐 Python | 📅 2026-02-17 - Docker image with Uvicorn managed by Gunicorn for high-performance FastAPI web applications in Python 3.7 and 3.6 with performance auto-tuning.
* [inboard](https://github.com/br3ndonland/inboard) ⭐ 317 | 🐛 0 | 🌐 Python | 📅 2026-02-20 - Docker images to power your FastAPI apps and help you ship faster.
...
* [Polar](https://github.com/polarsource/polar) ⭐ 9,452 | 🐛 327 | 🌐 Python | 📅 2026-02-20 - A funding and monetization platform for developers, built with FastAPI, SQLAlchemy, Alembic, and Arq.
...
* [FastAPI with Observability](https://github.com/Blueswen/fastapi-observability) ⭐ 1,072 | 🐛 6 | 🌐 Python | 📅 2025-05-11 - Observe FastAPI app with three pillars of observability: Traces (Tempo), Metrics (Prometheus), Logs (Loki) on Grafana through OpenTelemetry and OpenMetrics.
* [Bitcart](https://github.com/bitcart/bitcart) ⭐ 895 | 🐛 28 | 🌐 Python | 📅 2026-02-19 - Platform for merchants, users and developers which offers easy setup and use.
...
* [RealWorld Example App - mongo](https://github.com/markqiu/fastapi-mongodb-realworld-example-app) ⭐ 535 | 🐛 0 | 🌐 Python | 📅 2022-10-05
...
* [FuturamaAPI](https://github.com/koldakov/futuramaapi) ⭐ 357 | 🐛 2 | 🌐 Python | 📅 2026-02-20 - A REST and GraphQL playground built with best practices, providing WebSockets, SSE, callbacks, secret messages, and more.
...
* [FastAPI Websocket Broadcast](https://github.com/kthwaite/fastapi-websocket-broadcast) ⭐ 228 | 🐛 4 | 🌐 Python | 📅 2025-04-24 - Websocket 'broadcast' demo.
* [Markdown-Videos](https://github.com/Snailedlt/Markdown-Videos) ⭐ 178 | 🐛 28 | 🌐 Python | 📅 2025-11-21 - API for generating thumbnails to embed into your markdown content.
...
* [Mailer](https://github.com/rclement/mailer) ⭐ 151 | 🐛 0 | 🌐 Python | 📅 2026-02-20 - Dead-simple mailer micro-service for static websites.
