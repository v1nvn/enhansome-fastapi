...
# Awesome FastAPI | [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 458,412 | 🐛 66 | 📅 2026-04-19 with stars
...
* [SQLAlchemy Admin](https://github.com/aminalaee/sqladmin) ⭐ 2,714 | 🐛 79 | 🌐 Python | 📅 2026-04-19 - Admin Panel for FastAPI/Starlette that works with SQLAlchemy models.
...
* [Starlette Admin](https://github.com/jowilf/starlette-admin) ⭐ 989 | 🐛 88 | 🌐 Python | 📅 2026-04-20 - Admin framework for FastAPI/Starlette, supporting SQLAlchemy, SQLModel, MongoDB, and ODMantic.
...
* [FastAPI Users](https://github.com/fastapi-users/fastapi-users) ⭐ 6,102 | 🐛 5 | 🌐 Python | 📅 2026-03-30 - Account management, authentication, authorization.
* [AuthX](https://github.com/yezz123/AuthX) ⭐ 1,168 | 🐛 1 | 🌐 Python | 📅 2026-04-23 - Customizable Authentications and Oauth2 management for FastAPI.
...
* [FastAPI Guard](https://github.com/rennf93/fastapi-guard) ⭐ 730 | 🐛 1 | 🌐 Python | 📅 2026-04-24 - Rate Limiting, Automatically Ban IPs, Penetration Attack Detection, Whitelist/blacklist (countries, IPs, Cloud Providers), User Agent Filtering, Geolocation, Redis integration for persistence, and more.
...
* [Piccolo](https://github.com/piccolo-orm/piccolo) ⭐ 1,894 | 🐛 40 | 🌐 Python | 📅 2026-04-15 - An async ORM and query builder, supporting Postgres and SQLite, with batteries (migrations, security, etc).
...
* [Tortoise ORM](https://tortoise.github.io) - An easy-to-use asyncio ORM (Object Relational Mapper) inspired by Django.
  * [Aerich](https://github.com/tortoise/aerich) ⭐ 1,090 | 🐛 29 | 🌐 Python | 📅 2026-04-08 - Tortoise ORM migrations tools.
...
* [FastAPIwee](https://github.com/Ignisor/FastAPIwee) ⭐ 106 | 🐛 1 | 🌐 Python | 📅 2021-07-09 - A simple way to create REST API based on [PeeWee](https://github.com/coleifer/peewee) ⭐ 11,961 | 🐛 1 | 🌐 Python | 📅 2026-04-23 models.
...
* [asyncpgsa](https://github.com/CanopyTax/asyncpgsa) ⭐ 510 | 🐛 15 | 🌐 Python | 📅 2024-02-17 - A wrapper around [asyncpg](https://github.com/MagicStack/asyncpg) ⭐ 8,004 | 🐛 268 | 🌐 Python | 📅 2026-02-27 for use with [SQLAlchemy Core](https://docs.sqlalchemy.org/en/latest/core/).
...
* [PynamoDB](https://github.com/pynamodb/PynamoDB) ⭐ 2,649 | 🐛 318 | 🌐 Python | 📅 2026-01-06 - A pythonic interface to Amazon's DynamoDB.
...
* [Wireup](https://github.com/maldoinc/wireup) ⭐ 388 | 🐛 19 | 🌐 Python | 📅 2026-04-18 - Inject dependencies with zero runtime overhead in FastAPI; Share dependencies across web, cli or other interfaces.
...
* [Strawberry GraphQL](https://github.com/strawberry-graphql/strawberry) ⭐ 4,651 | 🐛 453 | 🌐 Python | 📅 2026-04-22 - Python GraphQL library based on dataclasses.
...
* [SlowApi](https://github.com/laurents/slowapi) ⭐ 1,959 | 🐛 102 | 🌐 Python | 📅 2026-04-21 - Rate limiter (based on [Flask-Limiter](https://flask-limiter.readthedocs.io)).
...
* [FastAPI Pagination](https://github.com/uriyyo/fastapi-pagination) ⭐ 1,646 | 🐛 7 | 🌐 Python | 📅 2026-04-24 - Pagination for FastAPI.
...
* [OpenTelemetry FastAPI Instrumentation](https://github.com/open-telemetry/opentelemetry-python-contrib/tree/main/instrumentation/opentelemetry-instrumentation-fastapi) ⭐ 1,032 | 🐛 668 | 🌐 Python | 📅 2026-04-23 - Library provides automatic and manual instrumentation of FastAPI web frameworks, instrumenting http requests served by applications utilizing the framework.
...
* [Source Code](https://github.com/fastapi/fastapi) ⭐ 97,582 | 🐛 173 | 🌐 Python | 📅 2026-04-23 - Hosted on GitHub.
...
* [FastAPI Best Practices](https://github.com/zhanymkanov/fastapi-best-practices) ⭐ 17,069 | 🐛 12 | 📅 2026-04-14 - Collection of best practices in a GitHub repo.
* [FastAPI Clean Example](https://github.com/ivan-borovets/fastapi-clean-example) ⭐ 539 | 🐛 0 | 🌐 Python | 📅 2026-04-17 - Clean Architecture backend example built with FastAPI.
...
* [Full Stack FastAPI and PostgreSQL - Base Project Generator](https://github.com/fastapi/full-stack-fastapi-template) ⭐ 42,822 | 🐛 28 | 🌐 TypeScript | 📅 2026-04-21 - Full Stack FastAPI Template
...
* [FastAPI template](https://github.com/s3rius/FastAPI-template) ⭐ 2,775 | 🐛 41 | 🌐 Python | 📅 2026-04-22 - Flexible, lightweight FastAPI project generator. It includes support for SQLAlchemy, multiple databases, CI/CD, Docker, and Kubernetes.
...
* [Polar](https://github.com/polarsource/polar) ⭐ 9,759 | 🐛 93 | 🌐 Python | 📅 2026-04-23 - A funding and monetization platform for developers, built with FastAPI, SQLAlchemy, Alembic, and Arq.
...
* [Bitcart](https://github.com/bitcart/bitcart) ⭐ 929 | 🐛 43 | 🌐 Python | 📅 2026-04-22 - Platform for merchants, users and developers which offers easy setup and use.
...
* [Mailer](https://github.com/rclement/mailer) ⭐ 149 | 🐛 9 | 🌐 Python | 📅 2026-04-23 - Dead-simple mailer micro-service for static websites.
