...
# Awesome FastAPI | [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 457,004 | 🐛 65 | 📅 2026-04-19 with stars
...
* [FastAPI Admin](https://github.com/fastapi-admin/fastapi-admin) ⭐ 3,754 | 🐛 75 | 🌐 Python | 📅 2025-04-05 - Functional admin panel that provides a user interface for performing CRUD operations on your data. Currently only works with the Tortoise ORM.
* [SQLAlchemy Admin](https://github.com/aminalaee/sqladmin) ⭐ 2,710 | 🐛 77 | 🌐 Python | 📅 2026-04-19 - Admin Panel for FastAPI/Starlette that works with SQLAlchemy models.
* [FastAPI Amis Admin](https://github.com/amisadmin/fastapi-amis-admin) ⭐ 1,535 | 🐛 77 | 🌐 Python | 📅 2025-12-15 - A high-performance, efficient and easily extensible FastAPI admin framework.
...
* [AuthX](https://github.com/yezz123/AuthX) ⭐ 1,167 | 🐛 5 | 🌐 Python | 📅 2026-04-13 - Customizable Authentications and Oauth2 management for FastAPI.
...
* [FastAPIwee](https://github.com/Ignisor/FastAPIwee) ⭐ 106 | 🐛 1 | 🌐 Python | 📅 2021-07-09 - A simple way to create REST API based on [PeeWee](https://github.com/coleifer/peewee) ⭐ 11,960 | 🐛 1 | 🌐 Python | 📅 2026-04-17 models.
...
* [asyncpgsa](https://github.com/CanopyTax/asyncpgsa) ⭐ 510 | 🐛 15 | 🌐 Python | 📅 2024-02-17 - A wrapper around [asyncpg](https://github.com/MagicStack/asyncpg) ⭐ 7,999 | 🐛 269 | 🌐 Python | 📅 2026-02-27 for use with [SQLAlchemy Core](https://docs.sqlalchemy.org/en/latest/core/).
...
* [Wireup](https://github.com/maldoinc/wireup) ⭐ 387 | 🐛 18 | 🌐 Python | 📅 2026-04-18 - Inject dependencies with zero runtime overhead in FastAPI; Share dependencies across web, cli or other interfaces.
...
* [FastAPI Code Generator](https://github.com/koxudaxi/fastapi-code-generator) ⭐ 1,385 | 🐛 82 | 🌐 Python | 📅 2026-04-20 - Create a FastAPI app from an OpenAPI file, enabling schema-driven development.
* [FastAPI Versioning](https://github.com/DeanWay/fastapi-versioning) ⭐ 847 | 🐛 35 | 🌐 Python | 📅 2023-07-25 - API versioning.
* [FastAPI MVC](https://github.com/fastapi-mvc/fastapi-mvc) ⭐ 797 | 🐛 33 | 🌐 Python | 📅 2026-04-14 - Developer productivity tool for making high-quality FastAPI production-ready APIs.
...
* [Strawberry GraphQL](https://github.com/strawberry-graphql/strawberry) ⭐ 4,648 | 🐛 456 | 🌐 Python | 📅 2026-04-19 - Python GraphQL library based on dataclasses.
...
* [SlowApi](https://github.com/laurents/slowapi) ⭐ 1,954 | 🐛 101 | 🌐 Python | 📅 2026-04-18 - Rate limiter (based on [Flask-Limiter](https://flask-limiter.readthedocs.io)).
...
* [FastAPI Pagination](https://github.com/uriyyo/fastapi-pagination) ⭐ 1,643 | 🐛 7 | 🌐 Python | 📅 2026-04-20 - Pagination for FastAPI.
...
* [FastAPI Limiter](https://github.com/long2ice/fastapi-limiter) ⭐ 767 | 🐛 29 | 🌐 Python | 📅 2026-02-06 - A request rate limiter for FastAPI.
...
* [Pydantic Resolve](https://github.com/allmonday/pydantic-resolve) ⭐ 319 | 🐛 3 | 🌐 Python | 📅 2026-04-20 -  Turns pydantic class into a powerful composable computing container by introducing resolve and post-process hooks.
...
* [Apitally](https://github.com/apitally/apitally-py) ⭐ 219 | 🐛 4 | 🌐 Python | 📅 2026-04-18 - API analytics, monitoring, and request logging for FastAPI.
...
* [Source Code](https://github.com/fastapi/fastapi) ⭐ 97,409 | 🐛 182 | 🌐 Python | 📅 2026-04-17 - Hosted on GitHub.
...
* [FastAPI Best Practices](https://github.com/zhanymkanov/fastapi-best-practices) ⭐ 17,024 | 🐛 12 | 📅 2026-04-14 - Collection of best practices in a GitHub repo.
...
* [Full Stack FastAPI and PostgreSQL - Base Project Generator](https://github.com/fastapi/full-stack-fastapi-template) ⭐ 42,735 | 🐛 26 | 🌐 TypeScript | 📅 2026-04-19 - Full Stack FastAPI Template
...
* [Polar](https://github.com/polarsource/polar) ⭐ 9,673 | 🐛 360 | 🌐 Python | 📅 2026-04-19 - A funding and monetization platform for developers, built with FastAPI, SQLAlchemy, Alembic, and Arq.
...
* [Bitcart](https://github.com/bitcart/bitcart) ⭐ 926 | 🐛 41 | 🌐 Python | 📅 2026-04-20 - Platform for merchants, users and developers which offers easy setup and use.
...
* [Mailer](https://github.com/rclement/mailer) ⭐ 149 | 🐛 6 | 🌐 Python | 📅 2026-04-19 - Dead-simple mailer micro-service for static websites.
