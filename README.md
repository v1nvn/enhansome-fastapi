...
# Awesome FastAPI | [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 458,700 | 🐛 68 | 📅 2026-04-19 with stars
...
* [SQLAlchemy Admin](https://github.com/aminalaee/sqladmin) ⭐ 2,715 | 🐛 79 | 🌐 Python | 📅 2026-04-19 - Admin Panel for FastAPI/Starlette that works with SQLAlchemy models.
* [FastAPI Amis Admin](https://github.com/amisadmin/fastapi-amis-admin) ⭐ 1,540 | 🐛 77 | 🌐 Python | 📅 2025-12-15 - A high-performance, efficient and easily extensible FastAPI admin framework.
...
* [FastAPI Users](https://github.com/fastapi-users/fastapi-users) ⭐ 6,104 | 🐛 5 | 🌐 Python | 📅 2026-03-30 - Account management, authentication, authorization.
* [AuthX](https://github.com/yezz123/AuthX) ⭐ 1,169 | 🐛 1 | 🌐 Python | 📅 2026-04-23 - Customizable Authentications and Oauth2 management for FastAPI.
...
* [FastAPI Login](https://github.com/maxrdu/fastapi_login) ⭐ 823 | 🐛 1 | 🌐 Python | 📅 2025-05-20 - Account management and authentication (based on [Flask-Login](https://github.com/maxcountryman/flask-login) ⭐ 3,678 | 🐛 19 | 🌐 Python | 📅 2025-08-27).
...
* [FastAPI Guard](https://github.com/rennf93/fastapi-guard) ⭐ 729 | 🐛 1 | 🌐 Python | 📅 2026-04-25 - Rate Limiting, Automatically Ban IPs, Penetration Attack Detection, Whitelist/blacklist (countries, IPs, Cloud Providers), User Agent Filtering, Geolocation, Redis integration for persistence, and more.
...
* [Piccolo](https://github.com/piccolo-orm/piccolo) ⭐ 1,895 | 🐛 40 | 🌐 Python | 📅 2026-04-15 - An async ORM and query builder, supporting Postgres and SQLite, with batteries (migrations, security, etc).
...
* [asyncpgsa](https://github.com/CanopyTax/asyncpgsa) ⭐ 510 | 🐛 15 | 🌐 Python | 📅 2024-02-17 - A wrapper around [asyncpg](https://github.com/MagicStack/asyncpg) ⭐ 8,005 | 🐛 268 | 🌐 Python | 📅 2026-02-27 for use with [SQLAlchemy Core](https://docs.sqlalchemy.org/en/latest/core/).
...
* [Wireup](https://github.com/maldoinc/wireup) ⭐ 389 | 🐛 19 | 🌐 Python | 📅 2026-04-18 - Inject dependencies with zero runtime overhead in FastAPI; Share dependencies across web, cli or other interfaces.
...
* [Strawberry GraphQL](https://github.com/strawberry-graphql/strawberry) ⭐ 4,651 | 🐛 451 | 🌐 Python | 📅 2026-04-24 - Python GraphQL library based on dataclasses.
...
* [SlowApi](https://github.com/laurents/slowapi) ⭐ 1,959 | 🐛 103 | 🌐 Python | 📅 2026-04-21 - Rate limiter (based on [Flask-Limiter](https://flask-limiter.readthedocs.io)).
* [FastAPI Cache](https://github.com/long2ice/fastapi-cache) ⭐ 1,858 | 🐛 106 | 🌐 Python | 📅 2025-06-30 - A tool to cache FastAPI response and function results, with support for Redis, Memcached, DynamoDB, and in-memory backends.
* [FastAPI Pagination](https://github.com/uriyyo/fastapi-pagination) ⭐ 1,644 | 🐛 7 | 🌐 Python | 📅 2026-04-24 - Pagination for FastAPI.
...
* [OpenTelemetry FastAPI Instrumentation](https://github.com/open-telemetry/opentelemetry-python-contrib/tree/main/instrumentation/opentelemetry-instrumentation-fastapi) ⭐ 1,032 | 🐛 667 | 🌐 Python | 📅 2026-04-24 - Library provides automatic and manual instrumentation of FastAPI web frameworks, instrumenting http requests served by applications utilizing the framework.
...
* [Apitally](https://github.com/apitally/apitally-py) ⭐ 219 | 🐛 6 | 🌐 Python | 📅 2026-04-25 - API analytics, monitoring, and request logging for FastAPI.
...
* [Source Code](https://github.com/fastapi/fastapi) ⭐ 97,622 | 🐛 173 | 🌐 Python | 📅 2026-04-24 - Hosted on GitHub.
...
* [FastAPI Best Practices](https://github.com/zhanymkanov/fastapi-best-practices) ⭐ 17,079 | 🐛 12 | 📅 2026-04-14 - Collection of best practices in a GitHub repo.
* [FastAPI Clean Example](https://github.com/ivan-borovets/fastapi-clean-example) ⭐ 538 | 🐛 0 | 🌐 Python | 📅 2026-04-17 - Clean Architecture backend example built with FastAPI.
...
* [Full Stack FastAPI and PostgreSQL - Base Project Generator](https://github.com/fastapi/full-stack-fastapi-template) ⭐ 42,838 | 🐛 29 | 🌐 TypeScript | 📅 2026-04-21 - Full Stack FastAPI Template
...
* [FastAPI template](https://github.com/s3rius/FastAPI-template) ⭐ 2,774 | 🐛 40 | 🌐 Python | 📅 2026-04-22 - Flexible, lightweight FastAPI project generator. It includes support for SQLAlchemy, multiple databases, CI/CD, Docker, and Kubernetes.
...
* [Polar](https://github.com/polarsource/polar) ⭐ 9,759 | 🐛 83 | 🌐 Python | 📅 2026-04-24 - A funding and monetization platform for developers, built with FastAPI, SQLAlchemy, Alembic, and Arq.
...
* [Bitcart](https://github.com/bitcart/bitcart) ⭐ 930 | 🐛 43 | 🌐 Python | 📅 2026-04-22 - Platform for merchants, users and developers which offers easy setup and use.
