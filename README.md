...
# Awesome FastAPI | [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 450,944 | 🐛 65 | 📅 2026-04-01 with stars
...
* [FastAPI Admin](https://github.com/fastapi-admin/fastapi-admin) ⭐ 3,746 | 🐛 75 | 🌐 Python | 📅 2025-04-05 - Functional admin panel that provides a user interface for performing CRUD operations on your data. Currently only works with the Tortoise ORM.
* [SQLAlchemy Admin](https://github.com/aminalaee/sqladmin) ⭐ 2,694 | 🐛 108 | 🌐 Python | 📅 2026-04-01 - Admin Panel for FastAPI/Starlette that works with SQLAlchemy models.
...
* [Starlette Admin](https://github.com/jowilf/starlette-admin) ⭐ 982 | 🐛 96 | 🌐 Python | 📅 2026-03-30 - Admin framework for FastAPI/Starlette, supporting SQLAlchemy, SQLModel, MongoDB, and ODMantic.
...
* [FastAPI Users](https://github.com/fastapi-users/fastapi-users) ⭐ 6,065 | 🐛 5 | 🌐 Python | 📅 2026-03-30 - Account management, authentication, authorization.
* [AuthX](https://github.com/yezz123/AuthX) ⭐ 1,158 | 🐛 6 | 🌐 Python | 📅 2026-03-30 - Customizable Authentications and Oauth2 management for FastAPI.
...
* [FastAPI Guard](https://github.com/rennf93/fastapi-guard) ⭐ 721 | 🐛 1 | 🌐 Python | 📅 2026-03-26 - Rate Limiting, Automatically Ban IPs, Penetration Attack Detection, Whitelist/blacklist (countries, IPs, Cloud Providers), User Agent Filtering, Geolocation, Redis integration for persistence, and more.
...
* [Tortoise ORM](https://tortoise.github.io) - An easy-to-use asyncio ORM (Object Relational Mapper) inspired by Django.
  * [Aerich](https://github.com/tortoise/aerich) ⭐ 1,089 | 🐛 28 | 🌐 Python | 📅 2026-03-31 - Tortoise ORM migrations tools.
...
* [Fastapi-SQLA](https://github.com/dialoguemd/fastapi-sqla) ⭐ 441 | 🐛 13 | 🌐 Python | 📅 2026-04-01 - SQLAlchemy extension for FastAPI with support for pagination, asyncio, and pytest.
...
* [FastAPIwee](https://github.com/Ignisor/FastAPIwee) ⭐ 106 | 🐛 1 | 🌐 Python | 📅 2021-07-09 - A simple way to create REST API based on [PeeWee](https://github.com/coleifer/peewee) ⭐ 11,958 | 🐛 1 | 🌐 Python | 📅 2026-03-26 models.
...
* [PyPika](https://github.com/kayak/pypika) ⭐ 2,899 | 🐛 231 | 🌐 Python | 📅 2026-02-04 - A SQL query builder that exposes the full richness of the SQL language.
* [asyncpgsa](https://github.com/CanopyTax/asyncpgsa) ⭐ 510 | 🐛 14 | 🌐 Python | 📅 2024-02-17 - A wrapper around [asyncpg](https://github.com/MagicStack/asyncpg) ⭐ 7,995 | 🐛 267 | 🌐 Python | 📅 2026-02-27 for use with [SQLAlchemy Core](https://docs.sqlalchemy.org/en/latest/core/).
...
* [Beanie](https://github.com/BeanieODM/beanie) ⭐ 2,670 | 🐛 85 | 🌐 Python | 📅 2026-03-30 - Asynchronous Python ODM for MongoDB, based on [Motor](https://motor.readthedocs.io/en/stable/) and [Pydantic](https://docs.pydantic.dev/latest/), which supports data and schema migrations out of the box.
...
* [Wireup](https://github.com/maldoinc/wireup) ⭐ 378 | 🐛 16 | 🌐 Python | 📅 2026-04-01 - Inject dependencies with zero runtime overhead in FastAPI; Share dependencies across web, cli or other interfaces.

### Developer Tools

* [Manage FastAPI](https://github.com/ycd/manage-fastapi) ⭐ 1,897 | 🐛 22 | 🌐 Python | 📅 2024-03-01 - CLI tool for generating and managing FastAPI projects.
* [FastAPI Code Generator](https://github.com/koxudaxi/fastapi-code-generator) ⭐ 1,383 | 🐛 79 | 🌐 Python | 📅 2026-03-16 - Create a FastAPI app from an OpenAPI file, enabling schema-driven development.
* [FastAPI Versioning](https://github.com/DeanWay/fastapi-versioning) ⭐ 845 | 🐛 35 | 🌐 Python | 📅 2023-07-25 - API versioning.
* [FastAPI MVC](https://github.com/fastapi-mvc/fastapi-mvc) ⭐ 795 | 🐛 32 | 🌐 Python | 📅 2026-04-01 - Developer productivity tool for making high-quality FastAPI production-ready APIs.
...
* [python-cqrs](https://github.com/pypatterns/python-cqrs) ⭐ 48 | 🐛 3 | 🌐 Python | 📅 2026-03-05 - Event-Driven Architecture Framework with CQRS, Transaction Outbox, Saga orchestration, seamless FastAPI/FastStream integration.
...
* [Strawberry GraphQL](https://github.com/strawberry-graphql/strawberry) ⭐ 4,637 | 🐛 448 | 🌐 Python | 📅 2026-04-01 - Python GraphQL library based on dataclasses.
...
* [SlowApi](https://github.com/laurents/slowapi) ⭐ 1,947 | 🐛 100 | 🌐 Python | 📅 2026-03-30 - Rate limiter (based on [Flask-Limiter](https://flask-limiter.readthedocs.io)).
* [FastAPI Cache](https://github.com/long2ice/fastapi-cache) ⭐ 1,853 | 🐛 106 | 🌐 Python | 📅 2025-06-30 - A tool to cache FastAPI response and function results, with support for Redis, Memcached, DynamoDB, and in-memory backends.
* [FastAPI Pagination](https://github.com/uriyyo/fastapi-pagination) ⭐ 1,638 | 🐛 7 | 🌐 Python | 📅 2026-04-01 - Pagination for FastAPI.
...
* [Prometheus FastAPI Instrumentator](https://github.com/trallnag/prometheus-fastapi-instrumentator) ⭐ 1,437 | 🐛 67 | 🌐 Python | 📅 2025-10-01 - A configurable and modular Prometheus Instrumentator for your FastAPI application.
* [OpenTelemetry FastAPI Instrumentation](https://github.com/open-telemetry/opentelemetry-python-contrib/tree/main/instrumentation/opentelemetry-instrumentation-fastapi) ⭐ 1,022 | 🐛 654 | 🌐 Python | 📅 2026-04-01 - Library provides automatic and manual instrumentation of FastAPI web frameworks, instrumenting http requests served by applications utilizing the framework.
...
* [Starlette Context](https://github.com/tomwojcik/starlette-context) ⭐ 608 | 🐛 2 | 🌐 Python | 📅 2026-04-01 - Allows you to store and access the request data anywhere in your project, useful for logging.
...
* [Pydantic Resolve](https://github.com/allmonday/pydantic-resolve) ⭐ 318 | 🐛 4 | 🌐 Python | 📅 2026-04-02 -  Turns pydantic class into a powerful composable computing container by introducing resolve and post-process hooks.
* [FastAPI Cache](https://github.com/comeuplater/fastapi_cache) ⭐ 306 | 🐛 9 | 🌐 Python | 📅 2021-09-30 - A simple lightweight cache system.
* [FastAPI Injectable](https://github.com/JasperSui/fastapi-injectable) ⭐ 287 | 🐛 5 | 🌐 Python | 📅 2026-04-01 - Use FastAPI's dependency injection outside route handlers in CLI tools, background tasks, workers, and more.
...
* [Source Code](https://github.com/fastapi/fastapi) ⭐ 96,754 | 🐛 165 | 🌐 Python | 📅 2026-04-01 - Hosted on GitHub.
...
* [FastAPI Best Practices](https://github.com/zhanymkanov/fastapi-best-practices) ⭐ 16,899 | 🐛 12 | 📅 2026-01-10 - Collection of best practices in a GitHub repo.
* [FastAPI Clean Example](https://github.com/ivan-borovets/fastapi-clean-example) ⭐ 525 | 🐛 4 | 🌐 Python | 📅 2026-04-01 - Clean Architecture backend example built with FastAPI.
...
* [Chalice](https://github.com/aws/chalice) ⭐ 11,047 | 🐛 494 | 🌐 Python | 📅 2025-05-29
...
* [Full Stack FastAPI and PostgreSQL - Base Project Generator](https://github.com/fastapi/full-stack-fastapi-template) ⭐ 42,409 | 🐛 18 | 🌐 TypeScript | 📅 2026-03-31 - Full Stack FastAPI Template
...
* [FastAPI template](https://github.com/s3rius/FastAPI-template) ⭐ 2,768 | 🐛 41 | 🌐 Python | 📅 2025-11-28 - Flexible, lightweight FastAPI project generator. It includes support for SQLAlchemy, multiple databases, CI/CD, Docker, and Kubernetes.
...
* [openapi-python-client](https://github.com/openapi-generators/openapi-python-client) ⭐ 1,930 | 🐛 98 | 🌐 Python | 📅 2026-03-16 - Generate modern FastAPI Python clients (via FastAPI) from OpenAPI.
...
* [uvicorn-gunicorn-fastapi-docker](https://github.com/tiangolo/uvicorn-gunicorn-fastapi-docker) ⭐ 2,913 | 🐛 8 | 🌐 Python | 📅 2026-03-25 - Docker image with Uvicorn managed by Gunicorn for high-performance FastAPI web applications in Python 3.7 and 3.6 with performance auto-tuning.
...
* [Polar](https://github.com/polarsource/polar) ⭐ 9,625 | 🐛 341 | 🌐 Python | 📅 2026-04-01 - A funding and monetization platform for developers, built with FastAPI, SQLAlchemy, Alembic, and Arq.
...
* [Awesome FastAPI Projects](https://github.com/Kludex/awesome-fastapi-projects) ⭐ 1,597 | 🐛 13 | 🌐 TypeScript | 📅 2026-03-30 - Organized list of projects that use FastAPI.
...
* [Bitcart](https://github.com/bitcart/bitcart) ⭐ 920 | 🐛 36 | 🌐 Python | 📅 2026-04-01 - Platform for merchants, users and developers which offers easy setup and use.
...
* [FuturamaAPI](https://github.com/koldakov/futuramaapi) ⭐ 377 | 🐛 3 | 🌐 Python | 📅 2026-03-11 - A REST and GraphQL playground built with best practices, providing WebSockets, SSE, callbacks, secret messages, and more.
...
* [Mailer](https://github.com/rclement/mailer) ⭐ 149 | 🐛 3 | 🌐 Python | 📅 2026-04-01 - Dead-simple mailer micro-service for static websites.
