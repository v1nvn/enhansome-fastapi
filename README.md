...
# Awesome FastAPI | [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 449,442 | 🐛 88 | 📅 2026-03-09 with stars
...
* [FastAPI Admin](https://github.com/fastapi-admin/fastapi-admin) ⭐ 3,742 | 🐛 75 | 🌐 Python | 📅 2025-04-05 - Functional admin panel that provides a user interface for performing CRUD operations on your data. Currently only works with the Tortoise ORM.
* [SQLAlchemy Admin](https://github.com/aminalaee/sqladmin) ⭐ 2,693 | 🐛 116 | 🌐 Python | 📅 2026-03-02 - Admin Panel for FastAPI/Starlette that works with SQLAlchemy models.
...
* [Starlette Admin](https://github.com/jowilf/starlette-admin) ⭐ 982 | 🐛 97 | 🌐 Python | 📅 2026-03-23 - Admin framework for FastAPI/Starlette, supporting SQLAlchemy, SQLModel, MongoDB, and ODMantic.
...
* [FastAPI Users](https://github.com/fastapi-users/fastapi-users) ⭐ 6,059 | 🐛 4 | 🌐 Python | 📅 2026-03-27 - Account management, authentication, authorization.
* [AuthX](https://github.com/yezz123/AuthX) ⭐ 1,157 | 🐛 0 | 🌐 Python | 📅 2026-03-24 - Customizable Authentications and Oauth2 management for FastAPI.
* [FastAPI JWT Auth](https://github.com/IndominusByte/fastapi-jwt-auth) ⭐ 828 | 🐛 61 | 🌐 Python | 📅 2024-04-12 - JWT auth (based on [Flask-JWT-Extended](https://github.com/vimalloc/flask-jwt-extended) ⭐ 1,589 | 🐛 17 | 🌐 Python | 📅 2024-12-30).
* [FastAPI Login](https://github.com/maxrdu/fastapi_login) ⭐ 823 | 🐛 1 | 🌐 Python | 📅 2025-05-20 - Account management and authentication (based on [Flask-Login](https://github.com/maxcountryman/flask-login) ⭐ 3,681 | 🐛 19 | 🌐 Python | 📅 2025-08-27).
...
* [FastAPI Cloud Auth](https://github.com/tokusumi/fastapi-cloudauth) ⭐ 438 | 🐛 37 | 🌐 Python | 📅 2023-05-17 - Simple integration between FastAPI and cloud authentication services (AWS Cognito, Auth0, Firebase Authentication).
...
* [GINO](https://github.com/python-gino/gino) ⭐ 2,809 | 🐛 55 | 🌐 Python | 📅 2022-02-12 - A lightweight asynchronous ORM built on top of SQLAlchemy core for Python asyncio.
...
* [Tortoise ORM](https://tortoise.github.io) - An easy-to-use asyncio ORM (Object Relational Mapper) inspired by Django.
  * [Aerich](https://github.com/tortoise/aerich) ⭐ 1,088 | 🐛 28 | 🌐 Python | 📅 2026-03-28 - Tortoise ORM migrations tools.
...
* [Fastapi-SQLA](https://github.com/dialoguemd/fastapi-sqla) ⭐ 441 | 🐛 15 | 🌐 Python | 📅 2026-03-28 - SQLAlchemy extension for FastAPI with support for pagination, asyncio, and pytest.
* [Edgy ORM](https://github.com/dymmond/edgy) ⭐ 424 | 🐛 1 | 🌐 Python | 📅 2026-03-06 - Complex databases made simple.
* [Saffier ORM](https://github.com/tarsil/saffier) ⭐ 150 | 🐛 1 | 🌐 Python | 📅 2026-03-26 - The only Python ORM you will ever need.
* [FastAPIwee](https://github.com/Ignisor/FastAPIwee) ⭐ 106 | 🐛 1 | 🌐 Python | 📅 2021-07-09 - A simple way to create REST API based on [PeeWee](https://github.com/coleifer/peewee) ⭐ 11,959 | 🐛 0 | 🌐 Python | 📅 2026-03-26 models.
...
* [PyPika](https://github.com/kayak/pypika) ⭐ 2,898 | 🐛 229 | 🌐 Python | 📅 2026-02-04 - A SQL query builder that exposes the full richness of the SQL language.
* [asyncpgsa](https://github.com/CanopyTax/asyncpgsa) ⭐ 510 | 🐛 14 | 🌐 Python | 📅 2024-02-17 - A wrapper around [asyncpg](https://github.com/MagicStack/asyncpg) ⭐ 7,991 | 🐛 267 | 🌐 Python | 📅 2026-02-27 for use with [SQLAlchemy Core](https://docs.sqlalchemy.org/en/latest/core/).
...
* [Beanie](https://github.com/BeanieODM/beanie) ⭐ 2,664 | 🐛 87 | 🌐 Python | 📅 2026-03-28 - Asynchronous Python ODM for MongoDB, based on [Motor](https://motor.readthedocs.io/en/stable/) and [Pydantic](https://docs.pydantic.dev/latest/), which supports data and schema migrations out of the box.
* [PynamoDB](https://github.com/pynamodb/PynamoDB) ⭐ 2,646 | 🐛 318 | 🌐 Python | 📅 2026-01-06 - A pythonic interface to Amazon's DynamoDB.
...
* [Wireup](https://github.com/maldoinc/wireup) ⭐ 375 | 🐛 13 | 🌐 Python | 📅 2026-03-22 - Inject dependencies with zero runtime overhead in FastAPI; Share dependencies across web, cli or other interfaces.
...
* [FastAPI Code Generator](https://github.com/koxudaxi/fastapi-code-generator) ⭐ 1,384 | 🐛 79 | 🌐 Python | 📅 2026-03-16 - Create a FastAPI app from an OpenAPI file, enabling schema-driven development.
* [FastAPI Versioning](https://github.com/DeanWay/fastapi-versioning) ⭐ 846 | 🐛 35 | 🌐 Python | 📅 2023-07-25 - API versioning.
* [FastAPI MVC](https://github.com/fastapi-mvc/fastapi-mvc) ⭐ 794 | 🐛 30 | 🌐 Python | 📅 2026-03-26 - Developer productivity tool for making high-quality FastAPI production-ready APIs.
...
* [FastAPI Profiler](https://github.com/sunhailin-Leo/fastapi_profiler) ⭐ 362 | 🐛 0 | 🌐 Python | 📅 2026-03-24 - A FastAPI Middleware of joerick/pyinstrument to check your service performance.
...
* [Strawberry GraphQL](https://github.com/strawberry-graphql/strawberry) ⭐ 4,636 | 🐛 450 | 🌐 Python | 📅 2026-03-26 - Python GraphQL library based on dataclasses.
...
* [SlowApi](https://github.com/laurents/slowapi) ⭐ 1,942 | 🐛 84 | 🌐 Python | 📅 2026-03-27 - Rate limiter (based on [Flask-Limiter](https://flask-limiter.readthedocs.io)).
...
* [FastAPI Pagination](https://github.com/uriyyo/fastapi-pagination) ⭐ 1,637 | 🐛 9 | 🌐 Python | 📅 2026-03-27 - Pagination for FastAPI.
...
* [OpenTelemetry FastAPI Instrumentation](https://github.com/open-telemetry/opentelemetry-python-contrib/tree/main/instrumentation/opentelemetry-instrumentation-fastapi) ⭐ 1,022 | 🐛 651 | 🌐 Python | 📅 2026-03-27 - Library provides automatic and manual instrumentation of FastAPI web frameworks, instrumenting http requests served by applications utilizing the framework.
* [FastAPI Limiter](https://github.com/long2ice/fastapi-limiter) ⭐ 761 | 🐛 29 | 🌐 Python | 📅 2026-02-06 - A request rate limiter for FastAPI.
* [FastAPI Contrib](https://github.com/identixone/fastapi_contrib) ⭐ 744 | 🐛 15 | 🌐 Python | 📅 2022-09-12 - Opinionated set of utilities: pagination, auth middleware, permissions, custom exception handlers, MongoDB support, and Opentracing middleware.
...
* [Starlette Context](https://github.com/tomwojcik/starlette-context) ⭐ 609 | 🐛 3 | 🌐 Python | 📅 2026-03-26 - Allows you to store and access the request data anywhere in your project, useful for logging.
...
* [FastAPI MQTT](https://github.com/sabuhish/fastapi-mqtt) ⭐ 384 | 🐛 5 | 🌐 Python | 📅 2024-05-22 - An extension for the MQTT protocol.
...
* [Pydantic Resolve](https://github.com/allmonday/pydantic-resolve) ⭐ 318 | 🐛 3 | 🌐 Python | 📅 2026-03-27 -  Turns pydantic class into a powerful composable computing container by introducing resolve and post-process hooks.
* [FastAPI Cache](https://github.com/comeuplater/fastapi_cache) ⭐ 306 | 🐛 9 | 🌐 Python | 📅 2021-09-30 - A simple lightweight cache system.
* [FastAPI Injectable](https://github.com/JasperSui/fastapi-injectable) ⭐ 287 | 🐛 2 | 🌐 Python | 📅 2026-03-26 - Use FastAPI's dependency injection outside route handlers in CLI tools, background tasks, workers, and more.
...
* [Apitally](https://github.com/apitally/apitally-py) ⭐ 217 | 🐛 4 | 🌐 Python | 📅 2026-03-28 - API analytics, monitoring, and request logging for FastAPI.
...
* [Source Code](https://github.com/fastapi/fastapi) ⭐ 96,632 | 🐛 168 | 🌐 Python | 📅 2026-03-26 - Hosted on GitHub.
...
* [FastAPI Best Practices](https://github.com/zhanymkanov/fastapi-best-practices) ⭐ 16,855 | 🐛 11 | 📅 2026-01-10 - Collection of best practices in a GitHub repo.
...
* [Chalice](https://github.com/aws/chalice) ⭐ 11,049 | 🐛 494 | 🌐 Python | 📅 2025-05-29
* [Vercel](https://vercel.com/) - (formerly Zeit) ([example](https://github.com/Snailedlt/Markdown-Videos) ⭐ 176 | 🐛 28 | 🌐 Python | 📅 2025-11-21).
...
* [Full Stack FastAPI and PostgreSQL - Base Project Generator](https://github.com/fastapi/full-stack-fastapi-template) ⭐ 42,302 | 🐛 17 | 🌐 TypeScript | 📅 2026-03-26 - Full Stack FastAPI Template
...
* [FastAPI and React Template](https://github.com/Buuntu/fastapi-react) ⭐ 2,578 | 🐛 43 | 🌐 Python | 📅 2023-10-06 - Full stack cookiecutter boilerplate using FastAPI, TypeScript, Docker, PostgreSQL, and React.
...
* [FastAPI Nano](https://github.com/rednafi/fastapi-nano) ⭐ 1,034 | 🐛 2 | 🌐 Python | 📅 2025-01-01 - Simple FastAPI template with factory pattern architecture.
...
* [uvicorn-gunicorn-fastapi-docker](https://github.com/tiangolo/uvicorn-gunicorn-fastapi-docker) ⭐ 2,914 | 🐛 8 | 🌐 Python | 📅 2026-03-25 - Docker image with Uvicorn managed by Gunicorn for high-performance FastAPI web applications in Python 3.7 and 3.6 with performance auto-tuning.
* [inboard](https://github.com/br3ndonland/inboard) ⭐ 318 | 🐛 0 | 🌐 Python | 📅 2026-03-15 - Docker images to power your FastAPI apps and help you ship faster.
...
* [Polar](https://github.com/polarsource/polar) ⭐ 9,610 | 🐛 331 | 🌐 Python | 📅 2026-03-27 - A funding and monetization platform for developers, built with FastAPI, SQLAlchemy, Alembic, and Arq.
...
* [TermPair](https://github.com/cs01/termpair) ⭐ 1,729 | 🐛 2 | 🌐 Rust | 📅 2026-03-25 - View and control terminals from your browser with end-to-end encryption.
* [Awesome FastAPI Projects](https://github.com/Kludex/awesome-fastapi-projects) ⭐ 1,594 | 🐛 11 | 🌐 TypeScript | 📅 2026-03-10 - Organized list of projects that use FastAPI.
...
* [RealWorld Example App - mongo](https://github.com/markqiu/fastapi-mongodb-realworld-example-app) ⭐ 533 | 🐛 0 | 🌐 Python | 📅 2022-10-05
* [JSON-RPC Server](https://github.com/smagafurov/fastapi-jsonrpc) ⭐ 419 | 🐛 11 | 🌐 Python | 📅 2026-02-09 - JSON-RPC server based on FastAPI.
...
* [FuturamaAPI](https://github.com/koldakov/futuramaapi) ⭐ 375 | 🐛 3 | 🌐 Python | 📅 2026-03-11 - A REST and GraphQL playground built with best practices, providing WebSockets, SSE, callbacks, secret messages, and more.
...
* [Markdown-Videos](https://github.com/Snailedlt/Markdown-Videos) ⭐ 176 | 🐛 28 | 🌐 Python | 📅 2025-11-21 - API for generating thumbnails to embed into your markdown content.
...
* [Mailer](https://github.com/rclement/mailer) ⭐ 149 | 🐛 7 | 🌐 Python | 📅 2026-03-27 - Dead-simple mailer micro-service for static websites.
