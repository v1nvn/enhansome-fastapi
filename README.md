...
# Awesome FastAPI | [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 451,627 | 🐛 59 | 📅 2026-04-02 with stars
...
* [FastAPI Admin](https://github.com/fastapi-admin/fastapi-admin) ⭐ 3,747 | 🐛 75 | 🌐 Python | 📅 2025-04-05 - Functional admin panel that provides a user interface for performing CRUD operations on your data. Currently only works with the Tortoise ORM.
* [SQLAlchemy Admin](https://github.com/aminalaee/sqladmin) ⭐ 2,698 | 🐛 105 | 🌐 Python | 📅 2026-04-02 - Admin Panel for FastAPI/Starlette that works with SQLAlchemy models.
...
* [Starlette Admin](https://github.com/jowilf/starlette-admin) ⭐ 983 | 🐛 96 | 🌐 Python | 📅 2026-03-30 - Admin framework for FastAPI/Starlette, supporting SQLAlchemy, SQLModel, MongoDB, and ODMantic.
...
* [AuthX](https://github.com/yezz123/AuthX) ⭐ 1,159 | 🐛 0 | 🌐 Python | 📅 2026-04-03 - Customizable Authentications and Oauth2 management for FastAPI.
...
* [FastAPI Auth](https://github.com/dmontagu/fastapi-auth) ⭐ 265 | 🐛 5 | 🌐 Python | 📅 2023-02-14 - Pluggable auth that supports the OAuth2 Password Flow with JWT access and refresh tokens.
...
* [FastAPI Casbin Auth](https://github.com/officialpycasbin/fastapi-casbin-auth) ⭐ 21 | 🐛 5 | 🌐 Python | 📅 2026-03-30 - Authorization which supports various access control models like RBAC, ReBAC and ABAC through Casbin.

### CyberSecurity

* [FastAPI Guard](https://github.com/rennf93/fastapi-guard) ⭐ 723 | 🐛 1 | 🌐 Python | 📅 2026-03-26 - Rate Limiting, Automatically Ban IPs, Penetration Attack Detection, Whitelist/blacklist (countries, IPs, Cloud Providers), User Agent Filtering, Geolocation, Redis integration for persistence, and more.
...
* [Piccolo](https://github.com/piccolo-orm/piccolo) ⭐ 1,877 | 🐛 38 | 🌐 Python | 📅 2026-03-24 - An async ORM and query builder, supporting Postgres and SQLite, with batteries (migrations, security, etc).
...
* [Fastapi-SQLA](https://github.com/dialoguemd/fastapi-sqla) ⭐ 441 | 🐛 15 | 🌐 Python | 📅 2026-04-04 - SQLAlchemy extension for FastAPI with support for pagination, asyncio, and pytest.
...
* [FastAPIwee](https://github.com/Ignisor/FastAPIwee) ⭐ 106 | 🐛 1 | 🌐 Python | 📅 2021-07-09 - A simple way to create REST API based on [PeeWee](https://github.com/coleifer/peewee) ⭐ 11,959 | 🐛 0 | 🌐 Python | 📅 2026-04-02 models.
...
* [asyncpgsa](https://github.com/CanopyTax/asyncpgsa) ⭐ 510 | 🐛 14 | 🌐 Python | 📅 2024-02-17 - A wrapper around [asyncpg](https://github.com/MagicStack/asyncpg) ⭐ 7,998 | 🐛 267 | 🌐 Python | 📅 2026-02-27 for use with [SQLAlchemy Core](https://docs.sqlalchemy.org/en/latest/core/).
...
* [Beanie](https://github.com/BeanieODM/beanie) ⭐ 2,671 | 🐛 85 | 🌐 Python | 📅 2026-03-30 - Asynchronous Python ODM for MongoDB, based on [Motor](https://motor.readthedocs.io/en/stable/) and [Pydantic](https://docs.pydantic.dev/latest/), which supports data and schema migrations out of the box.
...
* [Wireup](https://github.com/maldoinc/wireup) ⭐ 379 | 🐛 17 | 🌐 Python | 📅 2026-04-01 - Inject dependencies with zero runtime overhead in FastAPI; Share dependencies across web, cli or other interfaces.
...
* [python-cqrs](https://github.com/pypatterns/python-cqrs) ⭐ 49 | 🐛 3 | 🌐 Python | 📅 2026-03-05 - Event-Driven Architecture Framework with CQRS, Transaction Outbox, Saga orchestration, seamless FastAPI/FastStream integration.
...
* [Strawberry GraphQL](https://github.com/strawberry-graphql/strawberry) ⭐ 4,637 | 🐛 448 | 🌐 Python | 📅 2026-04-02 - Python GraphQL library based on dataclasses.
...
* [FastAPI Cache](https://github.com/long2ice/fastapi-cache) ⭐ 1,854 | 🐛 106 | 🌐 Python | 📅 2025-06-30 - A tool to cache FastAPI response and function results, with support for Redis, Memcached, DynamoDB, and in-memory backends.
* [FastAPI Pagination](https://github.com/uriyyo/fastapi-pagination) ⭐ 1,638 | 🐛 7 | 🌐 Python | 📅 2026-04-03 - Pagination for FastAPI.
* [FastAPI FastCRUD](https://github.com/benavlabs/fastcrud) ⭐ 1,507 | 🐛 22 | 🌐 Python | 📅 2026-03-11) - Robust async CRUD operations and flexible endpoint creation utilities.
...
* [OpenTelemetry FastAPI Instrumentation](https://github.com/open-telemetry/opentelemetry-python-contrib/tree/main/instrumentation/opentelemetry-instrumentation-fastapi) ⭐ 1,024 | 🐛 651 | 🌐 Python | 📅 2026-04-03 - Library provides automatic and manual instrumentation of FastAPI web frameworks, instrumenting http requests served by applications utilizing the framework.
...
* [Pydantic Resolve](https://github.com/allmonday/pydantic-resolve) ⭐ 318 | 🐛 5 | 🌐 Python | 📅 2026-04-04 -  Turns pydantic class into a powerful composable computing container by introducing resolve and post-process hooks.
* [FastAPI Cache](https://github.com/comeuplater/fastapi_cache) ⭐ 306 | 🐛 9 | 🌐 Python | 📅 2021-09-30 - A simple lightweight cache system.
* [FastAPI Injectable](https://github.com/JasperSui/fastapi-injectable) ⭐ 287 | 🐛 1 | 🌐 Python | 📅 2026-04-03 - Use FastAPI's dependency injection outside route handlers in CLI tools, background tasks, workers, and more.
...
* [Apitally](https://github.com/apitally/apitally-py) ⭐ 218 | 🐛 2 | 🌐 Python | 📅 2026-04-03 - API analytics, monitoring, and request logging for FastAPI.
...
* [Source Code](https://github.com/fastapi/fastapi) ⭐ 96,817 | 🐛 165 | 🌐 Python | 📅 2026-04-03 - Hosted on GitHub.
...
* [FastAPI Best Practices](https://github.com/zhanymkanov/fastapi-best-practices) ⭐ 16,916 | 🐛 12 | 📅 2026-01-10 - Collection of best practices in a GitHub repo.
* [FastAPI Clean Example](https://github.com/ivan-borovets/fastapi-clean-example) ⭐ 525 | 🐛 3 | 🌐 Python | 📅 2026-04-02 - Clean Architecture backend example built with FastAPI.
...
* [Chalice](https://github.com/aws/chalice) ⭐ 11,046 | 🐛 494 | 🌐 Python | 📅 2025-05-29
...
* [Full Stack FastAPI and PostgreSQL - Base Project Generator](https://github.com/fastapi/full-stack-fastapi-template) ⭐ 42,452 | 🐛 16 | 🌐 TypeScript | 📅 2026-04-03 - Full Stack FastAPI Template
...
* [inboard](https://github.com/br3ndonland/inboard) ⭐ 318 | 🐛 0 | 🌐 Python | 📅 2026-04-04 - Docker images to power your FastAPI apps and help you ship faster.
...
* [Polar](https://github.com/polarsource/polar) ⭐ 9,627 | 🐛 341 | 🌐 Python | 📅 2026-04-03 - A funding and monetization platform for developers, built with FastAPI, SQLAlchemy, Alembic, and Arq.
...
* [Bitcart](https://github.com/bitcart/bitcart) ⭐ 921 | 🐛 36 | 🌐 Python | 📅 2026-04-01 - Platform for merchants, users and developers which offers easy setup and use.
...
* [FuturamaAPI](https://github.com/koldakov/futuramaapi) ⭐ 378 | 🐛 3 | 🌐 Python | 📅 2026-03-11 - A REST and GraphQL playground built with best practices, providing WebSockets, SSE, callbacks, secret messages, and more.
...
* [Mailer](https://github.com/rclement/mailer) ⭐ 149 | 🐛 5 | 🌐 Python | 📅 2026-04-02 - Dead-simple mailer micro-service for static websites.
