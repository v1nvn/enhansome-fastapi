...
# Awesome FastAPI | [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 452,997 | 🐛 61 | 📅 2026-04-02 with stars
...
* [FastAPI Admin](https://github.com/fastapi-admin/fastapi-admin) ⭐ 3,749 | 🐛 75 | 🌐 Python | 📅 2025-04-05 - Functional admin panel that provides a user interface for performing CRUD operations on your data. Currently only works with the Tortoise ORM.
...
* [FastAPI Users](https://github.com/fastapi-users/fastapi-users) ⭐ 6,069 | 🐛 5 | 🌐 Python | 📅 2026-03-30 - Account management, authentication, authorization.
...
* [Piccolo](https://github.com/piccolo-orm/piccolo) ⭐ 1,882 | 🐛 38 | 🌐 Python | 📅 2026-03-24 - An async ORM and query builder, supporting Postgres and SQLite, with batteries (migrations, security, etc).
...
* [Fastapi-SQLA](https://github.com/dialoguemd/fastapi-sqla) ⭐ 442 | 🐛 13 | 🌐 Python | 📅 2026-04-07 - SQLAlchemy extension for FastAPI with support for pagination, asyncio, and pytest.
...
* [asyncpgsa](https://github.com/CanopyTax/asyncpgsa) ⭐ 510 | 🐛 15 | 🌐 Python | 📅 2024-02-17 - A wrapper around [asyncpg](https://github.com/MagicStack/asyncpg) ⭐ 7,996 | 🐛 268 | 🌐 Python | 📅 2026-02-27 for use with [SQLAlchemy Core](https://docs.sqlalchemy.org/en/latest/core/).
...
* [Strawberry GraphQL](https://github.com/strawberry-graphql/strawberry) ⭐ 4,640 | 🐛 445 | 🌐 Python | 📅 2026-04-07 - Python GraphQL library based on dataclasses.
* [FastAPI Utilities](https://github.com/fastapiutils/fastapi-utils) ⭐ 2,305 | 🐛 64 | 🌐 Python | 📅 2025-03-03 - Reusable utilities: class-based views, response inferring router, periodic tasks, timing middleware, SQLAlchemy session, OpenAPI spec simplification.
* [SlowApi](https://github.com/laurents/slowapi) ⭐ 1,951 | 🐛 101 | 🌐 Python | 📅 2026-03-30 - Rate limiter (based on [Flask-Limiter](https://flask-limiter.readthedocs.io)).
...
* [FastAPI Pagination](https://github.com/uriyyo/fastapi-pagination) ⭐ 1,640 | 🐛 7 | 🌐 Python | 📅 2026-04-08 - Pagination for FastAPI.
...
* [Pydantic Resolve](https://github.com/allmonday/pydantic-resolve) ⭐ 318 | 🐛 2 | 🌐 Python | 📅 2026-04-08 -  Turns pydantic class into a powerful composable computing container by introducing resolve and post-process hooks.
...
* [Source Code](https://github.com/fastapi/fastapi) ⭐ 96,951 | 🐛 166 | 🌐 Python | 📅 2026-04-07 - Hosted on GitHub.
...
* [FastAPI Best Practices](https://github.com/zhanymkanov/fastapi-best-practices) ⭐ 16,936 | 🐛 12 | 📅 2026-01-10 - Collection of best practices in a GitHub repo.
...
* [Full Stack FastAPI and PostgreSQL - Base Project Generator](https://github.com/fastapi/full-stack-fastapi-template) ⭐ 42,526 | 🐛 20 | 🌐 TypeScript | 📅 2026-04-04 - Full Stack FastAPI Template
...
* [openapi-python-client](https://github.com/openapi-generators/openapi-python-client) ⭐ 1,932 | 🐛 101 | 🌐 Python | 📅 2026-04-07 - Generate modern FastAPI Python clients (via FastAPI) from OpenAPI.
...
* [Polar](https://github.com/polarsource/polar) ⭐ 9,635 | 🐛 349 | 🌐 Python | 📅 2026-04-07 - A funding and monetization platform for developers, built with FastAPI, SQLAlchemy, Alembic, and Arq.
...
* [Bitcart](https://github.com/bitcart/bitcart) ⭐ 926 | 🐛 37 | 🌐 Python | 📅 2026-04-07 - Platform for merchants, users and developers which offers easy setup and use.
...
* [FuturamaAPI](https://github.com/koldakov/futuramaapi) ⭐ 380 | 🐛 3 | 🌐 Python | 📅 2026-04-07 - A REST and GraphQL playground built with best practices, providing WebSockets, SSE, callbacks, secret messages, and more.
...
* [Mailer](https://github.com/rclement/mailer) ⭐ 149 | 🐛 8 | 🌐 Python | 📅 2026-04-07 - Dead-simple mailer micro-service for static websites.
