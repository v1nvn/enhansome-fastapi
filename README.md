...
# Awesome FastAPI | [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 437,720 | 🐛 71 | 📅 2026-01-28 with stars
...
* [Starlette Admin](https://github.com/jowilf/starlette-admin) ⭐ 979 | 🐛 95 | 🌐 Python | 📅 2026-02-09 - Admin framework for FastAPI/Starlette, supporting SQLAlchemy, SQLModel, MongoDB, and ODMantic.
...
* [AuthX](https://github.com/yezz123/AuthX) ⭐ 1,140 | 🐛 0 | 🌐 Python | 📅 2026-02-11 - Customizable Authentications and Oauth2 management for FastAPI.
...
* [Piccolo](https://github.com/piccolo-orm/piccolo) ⭐ 1,857 | 🐛 59 | 🌐 Python | 📅 2026-02-12 - An async ORM and query builder, supporting Postgres and SQLite, with batteries (migrations, security, etc).
...
* [Fastapi-SQLA](https://github.com/dialoguemd/fastapi-sqla) ⭐ 434 | 🐛 13 | 🌐 Python | 📅 2026-02-16 - SQLAlchemy extension for FastAPI with support for pagination, asyncio, and pytest.
...
* [FastAPIwee](https://github.com/Ignisor/FastAPIwee) ⭐ 108 | 🐛 1 | 🌐 Python | 📅 2021-07-09 - A simple way to create REST API based on [PeeWee](https://github.com/coleifer/peewee) ⭐ 11,937 | 🐛 0 | 🌐 Python | 📅 2026-02-16 models.
...
* [asyncpgsa](https://github.com/CanopyTax/asyncpgsa) ⭐ 511 | 🐛 14 | 🌐 Python | 📅 2024-02-17 - A wrapper around [asyncpg](https://github.com/MagicStack/asyncpg) ⭐ 7,942 | 🐛 262 | 🌐 Python | 📅 2025-11-24 for use with [SQLAlchemy Core](https://docs.sqlalchemy.org/en/latest/core/).

#### ODMs

* [PynamoDB](https://github.com/pynamodb/PynamoDB) ⭐ 2,647 | 🐛 317 | 🌐 Python | 📅 2026-01-06 - A pythonic interface to Amazon's DynamoDB.
* [Beanie](https://github.com/BeanieODM/beanie) ⭐ 2,642 | 🐛 110 | 🌐 Python | 📅 2026-02-16 - Asynchronous Python ODM for MongoDB, based on [Motor](https://motor.readthedocs.io/en/stable/) and [Pydantic](https://docs.pydantic.dev/latest/), which supports data and schema migrations out of the box.
...
* [Wireup](https://github.com/maldoinc/wireup) ⭐ 349 | 🐛 15 | 🌐 Python | 📅 2026-02-09 - Inject dependencies with zero runtime overhead in FastAPI; Share dependencies across web, cli or other interfaces.
...
* [FastAPI Mail](https://github.com/sabuhish/fastapi-mail) ⭐ 972 | 🐛 22 | 🌐 Python | 📅 2026-02-11 - Lightweight mail system for sending emails and attachments (individual and bulk).

### Utils

* [Strawberry GraphQL](https://github.com/strawberry-graphql/strawberry) ⭐ 4,608 | 🐛 466 | 🌐 Python | 📅 2026-02-15 - Python GraphQL library based on dataclasses.
...
* [FastAPI Cache](https://github.com/long2ice/fastapi-cache) ⭐ 1,824 | 🐛 104 | 🌐 Python | 📅 2025-06-30 - A tool to cache FastAPI response and function results, with support for Redis, Memcached, DynamoDB, and in-memory backends.
* [FastAPI Pagination](https://github.com/uriyyo/fastapi-pagination) ⭐ 1,620 | 🐛 8 | 🌐 Python | 📅 2026-02-16 - Pagination for FastAPI.
* [FastAPI FastCRUD](https://github.com/benavlabs/fastcrud) ⭐ 1,480 | 🐛 21 | 🌐 Python | 📅 2026-01-27) - Robust async CRUD operations and flexible endpoint creation utilities.
...
* [OpenTelemetry FastAPI Instrumentation](https://github.com/open-telemetry/opentelemetry-python-contrib/tree/main/instrumentation/opentelemetry-instrumentation-fastapi) ⭐ 991 | 🐛 792 | 🌐 Python | 📅 2026-02-13 - Library provides automatic and manual instrumentation of FastAPI web frameworks, instrumenting http requests served by applications utilizing the framework.
...
* [ASGI Correlation ID](https://github.com/snok/asgi-correlation-id) ⭐ 630 | 🐛 4 | 🌐 Python | 📅 2024-10-17 - Request ID logging middleware.
...
* [Apitally](https://github.com/apitally/apitally-py) ⭐ 216 | 🐛 1 | 🌐 Python | 📅 2026-02-14 - API analytics, monitoring, and request logging for FastAPI.
...
* [Source Code](https://github.com/fastapi/fastapi) ⭐ 95,124 | 🐛 140 | 🌐 Python | 📅 2026-02-14 - Hosted on GitHub.
...
* [FastAPI Best Practices](https://github.com/zhanymkanov/fastapi-best-practices) ⭐ 16,479 | 🐛 9 | 📅 2026-01-10 - Collection of best practices in a GitHub repo.
...
* [Full Stack FastAPI and PostgreSQL - Base Project Generator](https://github.com/fastapi/full-stack-fastapi-template) ⭐ 41,573 | 🐛 11 | 🌐 TypeScript | 📅 2026-02-14 - Full Stack FastAPI Template
...
* [FastAPI template](https://github.com/s3rius/FastAPI-template) ⭐ 2,736 | 🐛 39 | 🌐 Python | 📅 2025-11-28 - Flexible, lightweight FastAPI project generator. It includes support for SQLAlchemy, multiple databases, CI/CD, Docker, and Kubernetes.
* [FastAPI and React Template](https://github.com/Buuntu/fastapi-react) ⭐ 2,576 | 🐛 42 | 🌐 Python | 📅 2023-10-06 - Full stack cookiecutter boilerplate using FastAPI, TypeScript, Docker, PostgreSQL, and React.
* [openapi-python-client](https://github.com/openapi-generators/openapi-python-client) ⭐ 1,906 | 🐛 93 | 🌐 Python | 📅 2026-02-16 - Generate modern FastAPI Python clients (via FastAPI) from OpenAPI.
...
* [cookiecutter-fastapi](https://github.com/arthurhenrique/cookiecutter-fastapi) ⭐ 702 | 🐛 1 | 🌐 Python | 📅 2025-08-25 - Cookiecutter template for FastAPI projects using: Machine Learning, Poetry, Azure Pipelines and pytest.
...
* [uvicorn-gunicorn-fastapi-docker](https://github.com/tiangolo/uvicorn-gunicorn-fastapi-docker) ⭐ 2,908 | 🐛 4 | 🌐 Python | 📅 2026-02-13 - Docker image with Uvicorn managed by Gunicorn for high-performance FastAPI web applications in Python 3.7 and 3.6 with performance auto-tuning.
...
* [Polar](https://github.com/polarsource/polar) ⭐ 9,430 | 🐛 331 | 🌐 Python | 📅 2026-02-15 - A funding and monetization platform for developers, built with FastAPI, SQLAlchemy, Alembic, and Arq.
...
* [Mailer](https://github.com/rclement/mailer) ⭐ 151 | 🐛 0 | 🌐 Python | 📅 2026-02-14 - Dead-simple mailer micro-service for static websites.
