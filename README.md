...
# Awesome FastAPI | [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 437,047 | 🐛 69 | 📅 2026-01-28 with stars
...
* [FastAPI Admin](https://github.com/fastapi-admin/fastapi-admin) ⭐ 3,706 | 🐛 74 | 🌐 Python | 📅 2025-04-05 - Functional admin panel that provides a user interface for performing CRUD operations on your data. Currently only works with the Tortoise ORM.
* [SQLAlchemy Admin](https://github.com/aminalaee/sqladmin) ⭐ 2,655 | 🐛 105 | 🌐 Python | 📅 2026-02-10 - Admin Panel for FastAPI/Starlette that works with SQLAlchemy models.
...
* [FastAPI Users](https://github.com/fastapi-users/fastapi-users) ⭐ 5,993 | 🐛 4 | 🌐 Python | 📅 2026-02-05 - Account management, authentication, authorization.
* [AuthX](https://github.com/yezz123/AuthX) ⭐ 1,141 | 🐛 0 | 🌐 Python | 📅 2026-02-11 - Customizable Authentications and Oauth2 management for FastAPI.
...
* [Piccolo](https://github.com/piccolo-orm/piccolo) ⭐ 1,857 | 🐛 60 | 🌐 Python | 📅 2026-02-12 - An async ORM and query builder, supporting Postgres and SQLite, with batteries (migrations, security, etc).
...
* [Edgy ORM](https://github.com/dymmond/edgy) ⭐ 421 | 🐛 3 | 🌐 Python | 📅 2026-02-12 - Complex databases made simple.
* [Saffier ORM](https://github.com/tarsil/saffier) ⭐ 152 | 🐛 10 | 🌐 Python | 📅 2026-01-26 - The only Python ORM you will ever need.
* [FastAPIwee](https://github.com/Ignisor/FastAPIwee) ⭐ 108 | 🐛 1 | 🌐 Python | 📅 2021-07-09 - A simple way to create REST API based on [PeeWee](https://github.com/coleifer/peewee) ⭐ 11,939 | 🐛 0 | 🌐 Python | 📅 2026-02-12 models.
...
* [asyncpgsa](https://github.com/CanopyTax/asyncpgsa) ⭐ 511 | 🐛 14 | 🌐 Python | 📅 2024-02-17 - A wrapper around [asyncpg](https://github.com/MagicStack/asyncpg) ⭐ 7,936 | 🐛 261 | 🌐 Python | 📅 2025-11-24 for use with [SQLAlchemy Core](https://docs.sqlalchemy.org/en/latest/core/).

#### ODMs

* [PynamoDB](https://github.com/pynamodb/PynamoDB) ⭐ 2,647 | 🐛 317 | 🌐 Python | 📅 2026-01-06 - A pythonic interface to Amazon's DynamoDB.
* [Beanie](https://github.com/BeanieODM/beanie) ⭐ 2,641 | 🐛 111 | 🌐 Python | 📅 2026-02-13 - Asynchronous Python ODM for MongoDB, based on [Motor](https://motor.readthedocs.io/en/stable/) and [Pydantic](https://docs.pydantic.dev/latest/), which supports data and schema migrations out of the box.
...
* [Wireup](https://github.com/maldoinc/wireup) ⭐ 346 | 🐛 15 | 🌐 Python | 📅 2026-02-09 - Inject dependencies with zero runtime overhead in FastAPI; Share dependencies across web, cli or other interfaces.
...
* [FastAPI Mail](https://github.com/sabuhish/fastapi-mail) ⭐ 971 | 🐛 22 | 🌐 Python | 📅 2026-02-11 - Lightweight mail system for sending emails and attachments (individual and bulk).

### Utils

* [Strawberry GraphQL](https://github.com/strawberry-graphql/strawberry) ⭐ 4,610 | 🐛 465 | 🌐 Python | 📅 2026-02-12 - Python GraphQL library based on dataclasses.
* [FastAPI Utilities](https://github.com/fastapiutils/fastapi-utils) ⭐ 2,302 | 🐛 65 | 🌐 Python | 📅 2025-03-03 - Reusable utilities: class-based views, response inferring router, periodic tasks, timing middleware, SQLAlchemy session, OpenAPI spec simplification.
* [SlowApi](https://github.com/laurents/slowapi) ⭐ 1,908 | 🐛 93 | 🌐 Python | 📅 2025-08-10 - Rate limiter (based on [Flask-Limiter](https://flask-limiter.readthedocs.io)).
* [FastAPI Cache](https://github.com/long2ice/fastapi-cache) ⭐ 1,820 | 🐛 104 | 🌐 Python | 📅 2025-06-30 - A tool to cache FastAPI response and function results, with support for Redis, Memcached, DynamoDB, and in-memory backends.
...
* [Prometheus FastAPI Instrumentator](https://github.com/trallnag/prometheus-fastapi-instrumentator) ⭐ 1,426 | 🐛 66 | 🌐 Python | 📅 2025-10-01 - A configurable and modular Prometheus Instrumentator for your FastAPI application.
* [OpenTelemetry FastAPI Instrumentation](https://github.com/open-telemetry/opentelemetry-python-contrib/tree/main/instrumentation/opentelemetry-instrumentation-fastapi) ⭐ 992 | 🐛 788 | 🌐 Python | 📅 2026-02-11 - Library provides automatic and manual instrumentation of FastAPI web frameworks, instrumenting http requests served by applications utilizing the framework.
...
* [FastAPI Limiter](https://github.com/long2ice/fastapi-limiter) ⭐ 739 | 🐛 26 | 🌐 Python | 📅 2026-02-06 - A request rate limiter for FastAPI.
* [ASGI Correlation ID](https://github.com/snok/asgi-correlation-id) ⭐ 628 | 🐛 4 | 🌐 Python | 📅 2024-10-17 - Request ID logging middleware.
...
* [FastAPI Plugins](https://github.com/madkote/fastapi-plugins) ⭐ 610 | 🐛 3 | 🌐 Python | 📅 2025-07-09 - Redis and Scheduler plugins.
...
* [Apitally](https://github.com/apitally/apitally-py) ⭐ 216 | 🐛 1 | 🌐 Python | 📅 2026-02-10 - API analytics, monitoring, and request logging for FastAPI.
...
* [Source Code](https://github.com/fastapi/fastapi) ⭐ 95,066 | 🐛 158 | 🌐 Python | 📅 2026-02-12 - Hosted on GitHub.
...
* [FastAPI Best Practices](https://github.com/zhanymkanov/fastapi-best-practices) ⭐ 16,452 | 🐛 9 | 📅 2026-01-10 - Collection of best practices in a GitHub repo.
...
* [Chalice](https://github.com/aws/chalice) ⭐ 11,064 | 🐛 493 | 🌐 Python | 📅 2025-05-29
...
* [Full Stack FastAPI and PostgreSQL - Base Project Generator](https://github.com/fastapi/full-stack-fastapi-template) ⭐ 41,543 | 🐛 7 | 🌐 TypeScript | 📅 2026-02-12 - Full Stack FastAPI Template
...
* [openapi-python-client](https://github.com/openapi-generators/openapi-python-client) ⭐ 1,905 | 🐛 91 | 🌐 Python | 📅 2026-02-12 - Generate modern FastAPI Python clients (via FastAPI) from OpenAPI.
...
* [uvicorn-gunicorn-fastapi-docker](https://github.com/tiangolo/uvicorn-gunicorn-fastapi-docker) ⭐ 2,910 | 🐛 4 | 🌐 Python | 📅 2026-02-12 - Docker image with Uvicorn managed by Gunicorn for high-performance FastAPI web applications in Python 3.7 and 3.6 with performance auto-tuning.
...
* [Polar](https://github.com/polarsource/polar) ⭐ 9,429 | 🐛 329 | 🌐 Python | 📅 2026-02-12 - A funding and monetization platform for developers, built with FastAPI, SQLAlchemy, Alembic, and Arq.
...
* [Bitcart](https://github.com/bitcart/bitcart) ⭐ 890 | 🐛 26 | 🌐 Python | 📅 2026-02-12 - Platform for merchants, users and developers which offers easy setup and use.
...
* [FuturamaAPI](https://github.com/koldakov/futuramaapi) ⭐ 356 | 🐛 2 | 🌐 Python | 📅 2026-02-12 - A REST and GraphQL playground built with best practices, providing WebSockets, SSE, callbacks, secret messages, and more.
