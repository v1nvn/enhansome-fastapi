...
# Awesome FastAPI | [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 456,115 | 🐛 64 | 📅 2026-04-02 with stars
...
* [SQLAlchemy Admin](https://github.com/aminalaee/sqladmin) ⭐ 2,707 | 🐛 99 | 🌐 Python | 📅 2026-04-13 - Admin Panel for FastAPI/Starlette that works with SQLAlchemy models.
...
* [Fastapi-SQLA](https://github.com/dialoguemd/fastapi-sqla) ⭐ 443 | 🐛 12 | 🌐 Python | 📅 2026-04-16 - SQLAlchemy extension for FastAPI with support for pagination, asyncio, and pytest.
...
* [asyncpgsa](https://github.com/CanopyTax/asyncpgsa) ⭐ 509 | 🐛 15 | 🌐 Python | 📅 2024-02-17 - A wrapper around [asyncpg](https://github.com/MagicStack/asyncpg) ⭐ 8,003 | 🐛 269 | 🌐 Python | 📅 2026-02-27 for use with [SQLAlchemy Core](https://docs.sqlalchemy.org/en/latest/core/).

#### ODMs

* [MongoEngine](https://github.com/MongoEngine/mongoengine) ⭐ 4,354 | 🐛 349 | 🌐 Python | 📅 2026-03-10 - A Document-Object Mapper (think ORM, but for document databases) for working with MongoDB from Python.
...
* [FastAPI Code Generator](https://github.com/koxudaxi/fastapi-code-generator) ⭐ 1,384 | 🐛 70 | 🌐 Python | 📅 2026-04-17 - Create a FastAPI app from an OpenAPI file, enabling schema-driven development.
...
* [Strawberry GraphQL](https://github.com/strawberry-graphql/strawberry) ⭐ 4,647 | 🐛 450 | 🌐 Python | 📅 2026-04-16 - Python GraphQL library based on dataclasses.
...
* [FastAPI Pagination](https://github.com/uriyyo/fastapi-pagination) ⭐ 1,642 | 🐛 7 | 🌐 Python | 📅 2026-04-17 - Pagination for FastAPI.
...
* [OpenTelemetry FastAPI Instrumentation](https://github.com/open-telemetry/opentelemetry-python-contrib/tree/main/instrumentation/opentelemetry-instrumentation-fastapi) ⭐ 1,029 | 🐛 673 | 🌐 Python | 📅 2026-04-17 - Library provides automatic and manual instrumentation of FastAPI web frameworks, instrumenting http requests served by applications utilizing the framework.
...
* [Source Code](https://github.com/fastapi/fastapi) ⭐ 97,315 | 🐛 177 | 🌐 Python | 📅 2026-04-17 - Hosted on GitHub.
...
* [FastAPI Best Practices](https://github.com/zhanymkanov/fastapi-best-practices) ⭐ 17,007 | 🐛 12 | 📅 2026-04-14 - Collection of best practices in a GitHub repo.
* [FastAPI Clean Example](https://github.com/ivan-borovets/fastapi-clean-example) ⭐ 532 | 🐛 0 | 🌐 Python | 📅 2026-04-14 - Clean Architecture backend example built with FastAPI.
...
* [Full Stack FastAPI and PostgreSQL - Base Project Generator](https://github.com/fastapi/full-stack-fastapi-template) ⭐ 42,679 | 🐛 25 | 🌐 TypeScript | 📅 2026-04-16 - Full Stack FastAPI Template
...
* [FastAPI template](https://github.com/s3rius/FastAPI-template) ⭐ 2,774 | 🐛 41 | 🌐 Python | 📅 2026-04-17 - Flexible, lightweight FastAPI project generator. It includes support for SQLAlchemy, multiple databases, CI/CD, Docker, and Kubernetes.
...
* [openapi-python-client](https://github.com/openapi-generators/openapi-python-client) ⭐ 1,934 | 🐛 107 | 🌐 Python | 📅 2026-04-10 - Generate modern FastAPI Python clients (via FastAPI) from OpenAPI.
...
* [Polar](https://github.com/polarsource/polar) ⭐ 9,654 | 🐛 366 | 🌐 Python | 📅 2026-04-16 - A funding and monetization platform for developers, built with FastAPI, SQLAlchemy, Alembic, and Arq.
...
* [Bitcart](https://github.com/bitcart/bitcart) ⭐ 925 | 🐛 38 | 🌐 Python | 📅 2026-04-16 - Platform for merchants, users and developers which offers easy setup and use.
...
* [JSON-RPC Server](https://github.com/smagafurov/fastapi-jsonrpc) ⭐ 419 | 🐛 11 | 🌐 Python | 📅 2026-04-16 - JSON-RPC server based on FastAPI.
...
* [Mailer](https://github.com/rclement/mailer) ⭐ 149 | 🐛 5 | 🌐 Python | 📅 2026-04-16 - Dead-simple mailer micro-service for static websites.
