...
# Awesome FastAPI | [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 450,300 | 🐛 88 | 📅 2026-03-09 with stars
...
* [SQLAlchemy Admin](https://github.com/aminalaee/sqladmin) ⭐ 2,696 | 🐛 105 | 🌐 Python | 📅 2026-03-30 - Admin Panel for FastAPI/Starlette that works with SQLAlchemy models.
...
* [Starlette Admin](https://github.com/jowilf/starlette-admin) ⭐ 983 | 🐛 97 | 🌐 Python | 📅 2026-03-30 - Admin framework for FastAPI/Starlette, supporting SQLAlchemy, SQLModel, MongoDB, and ODMantic.
...
* [FastAPI Users](https://github.com/fastapi-users/fastapi-users) ⭐ 6,062 | 🐛 5 | 🌐 Python | 📅 2026-03-30 - Account management, authentication, authorization.
* [AuthX](https://github.com/yezz123/AuthX) ⭐ 1,159 | 🐛 6 | 🌐 Python | 📅 2026-03-30 - Customizable Authentications and Oauth2 management for FastAPI.
* [FastAPI JWT Auth](https://github.com/IndominusByte/fastapi-jwt-auth) ⭐ 827 | 🐛 61 | 🌐 Python | 📅 2024-04-12 - JWT auth (based on [Flask-JWT-Extended](https://github.com/vimalloc/flask-jwt-extended) ⭐ 1,588 | 🐛 17 | 🌐 Python | 📅 2024-12-30).
...
* [FastAPI Auth](https://github.com/dmontagu/fastapi-auth) ⭐ 264 | 🐛 5 | 🌐 Python | 📅 2023-02-14 - Pluggable auth that supports the OAuth2 Password Flow with JWT access and refresh tokens.
...
* [FastAPI Casbin Auth](https://github.com/officialpycasbin/fastapi-casbin-auth) ⭐ 20 | 🐛 5 | 🌐 Python | 📅 2026-03-30 - Authorization which supports various access control models like RBAC, ReBAC and ABAC through Casbin.

### CyberSecurity

* [FastAPI Guard](https://github.com/rennf93/fastapi-guard) ⭐ 719 | 🐛 1 | 🌐 Python | 📅 2026-03-26 - Rate Limiting, Automatically Ban IPs, Penetration Attack Detection, Whitelist/blacklist (countries, IPs, Cloud Providers), User Agent Filtering, Geolocation, Redis integration for persistence, and more.
...
* [GINO](https://github.com/python-gino/gino) ⭐ 2,809 | 🐛 55 | 🌐 Python | 📅 2022-02-12 - A lightweight asynchronous ORM built on top of SQLAlchemy core for Python asyncio.
  * [FastAPI Example](https://github.com/leosussan/fastapi-gino-arq-uvicorn) ⭐ 559 | 🐛 5 | 🌐 Python | 📅 2022-12-08
...
* [Tortoise ORM](https://tortoise.github.io) - An easy-to-use asyncio ORM (Object Relational Mapper) inspired by Django.
  * [Aerich](https://github.com/tortoise/aerich) ⭐ 1,088 | 🐛 29 | 🌐 Python | 📅 2026-03-30 - Tortoise ORM migrations tools.
...
* [Fastapi-SQLA](https://github.com/dialoguemd/fastapi-sqla) ⭐ 441 | 🐛 14 | 🌐 Python | 📅 2026-03-30 - SQLAlchemy extension for FastAPI with support for pagination, asyncio, and pytest.
...
* [asyncpgsa](https://github.com/CanopyTax/asyncpgsa) ⭐ 510 | 🐛 14 | 🌐 Python | 📅 2024-02-17 - A wrapper around [asyncpg](https://github.com/MagicStack/asyncpg) ⭐ 7,993 | 🐛 267 | 🌐 Python | 📅 2026-02-27 for use with [SQLAlchemy Core](https://docs.sqlalchemy.org/en/latest/core/).

#### ODMs

* [MongoEngine](https://github.com/MongoEngine/mongoengine) ⭐ 4,348 | 🐛 348 | 🌐 Python | 📅 2026-03-10 - A Document-Object Mapper (think ORM, but for document databases) for working with MongoDB from Python.
* [Beanie](https://github.com/BeanieODM/beanie) ⭐ 2,668 | 🐛 86 | 🌐 Python | 📅 2026-03-30 - Asynchronous Python ODM for MongoDB, based on [Motor](https://motor.readthedocs.io/en/stable/) and [Pydantic](https://docs.pydantic.dev/latest/), which supports data and schema migrations out of the box.
...
* [FastAPI MVC](https://github.com/fastapi-mvc/fastapi-mvc) ⭐ 795 | 🐛 31 | 🌐 Python | 📅 2026-03-30 - Developer productivity tool for making high-quality FastAPI production-ready APIs.
...
* [Strawberry GraphQL](https://github.com/strawberry-graphql/strawberry) ⭐ 4,633 | 🐛 448 | 🌐 Python | 📅 2026-03-30 - Python GraphQL library based on dataclasses.
...
* [SlowApi](https://github.com/laurents/slowapi) ⭐ 1,944 | 🐛 100 | 🌐 Python | 📅 2026-03-30 - Rate limiter (based on [Flask-Limiter](https://flask-limiter.readthedocs.io)).
...
* [FastAPI Pagination](https://github.com/uriyyo/fastapi-pagination) ⭐ 1,637 | 🐛 6 | 🌐 Python | 📅 2026-03-31 - Pagination for FastAPI.
...
* [OpenTelemetry FastAPI Instrumentation](https://github.com/open-telemetry/opentelemetry-python-contrib/tree/main/instrumentation/opentelemetry-instrumentation-fastapi) ⭐ 1,021 | 🐛 656 | 🌐 Python | 📅 2026-03-28 - Library provides automatic and manual instrumentation of FastAPI web frameworks, instrumenting http requests served by applications utilizing the framework.
* [FastAPI Limiter](https://github.com/long2ice/fastapi-limiter) ⭐ 763 | 🐛 29 | 🌐 Python | 📅 2026-02-06 - A request rate limiter for FastAPI.
...
* [Starlette Context](https://github.com/tomwojcik/starlette-context) ⭐ 608 | 🐛 4 | 🌐 Python | 📅 2026-03-30 - Allows you to store and access the request data anywhere in your project, useful for logging.
...
* [Pydantic Resolve](https://github.com/allmonday/pydantic-resolve) ⭐ 318 | 🐛 5 | 🌐 Python | 📅 2026-03-31 -  Turns pydantic class into a powerful composable computing container by introducing resolve and post-process hooks.
...
* [Source Code](https://github.com/fastapi/fastapi) ⭐ 96,691 | 🐛 170 | 🌐 Python | 📅 2026-03-30 - Hosted on GitHub.
...
* [FastAPI Best Practices](https://github.com/zhanymkanov/fastapi-best-practices) ⭐ 16,890 | 🐛 12 | 📅 2026-01-10 - Collection of best practices in a GitHub repo.
...
* [Chalice](https://github.com/aws/chalice) ⭐ 11,045 | 🐛 494 | 🌐 Python | 📅 2025-05-29
...
* [Full Stack FastAPI and PostgreSQL - Base Project Generator](https://github.com/fastapi/full-stack-fastapi-template) ⭐ 42,364 | 🐛 20 | 🌐 TypeScript | 📅 2026-03-30 - Full Stack FastAPI Template
...
* [FastAPI template](https://github.com/s3rius/FastAPI-template) ⭐ 2,767 | 🐛 41 | 🌐 Python | 📅 2025-11-28 - Flexible, lightweight FastAPI project generator. It includes support for SQLAlchemy, multiple databases, CI/CD, Docker, and Kubernetes.
...
* [fastapi-gino-arq-uvicorn](https://github.com/leosussan/fastapi-gino-arq-uvicorn) ⭐ 559 | 🐛 5 | 🌐 Python | 📅 2022-12-08 - Template for a high-performance async REST API, in Python. FastAPI + GINO + Arq + Uvicorn (w/ Redis and PostgreSQL).
...
* [Polar](https://github.com/polarsource/polar) ⭐ 9,623 | 🐛 342 | 🌐 Python | 📅 2026-03-30 - A funding and monetization platform for developers, built with FastAPI, SQLAlchemy, Alembic, and Arq.
...
* [Bitcart](https://github.com/bitcart/bitcart) ⭐ 921 | 🐛 38 | 🌐 Python | 📅 2026-03-30 - Platform for merchants, users and developers which offers easy setup and use.
...
* [Mailer](https://github.com/rclement/mailer) ⭐ 149 | 🐛 2 | 🌐 Python | 📅 2026-03-30 - Dead-simple mailer micro-service for static websites.
