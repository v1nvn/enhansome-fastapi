...
# Awesome FastAPI | [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 451,319 | 🐛 59 | 📅 2026-04-02 with stars
...
* [SQLAlchemy Admin](https://github.com/aminalaee/sqladmin) ⭐ 2,695 | 🐛 105 | 🌐 Python | 📅 2026-04-02 - Admin Panel for FastAPI/Starlette that works with SQLAlchemy models.
...
* [FastAPI Guard](https://github.com/rennf93/fastapi-guard) ⭐ 722 | 🐛 1 | 🌐 Python | 📅 2026-03-26 - Rate Limiting, Automatically Ban IPs, Penetration Attack Detection, Whitelist/blacklist (countries, IPs, Cloud Providers), User Agent Filtering, Geolocation, Redis integration for persistence, and more.
...
* [Piccolo](https://github.com/piccolo-orm/piccolo) ⭐ 1,878 | 🐛 38 | 🌐 Python | 📅 2026-03-24 - An async ORM and query builder, supporting Postgres and SQLite, with batteries (migrations, security, etc).
...
* [Fastapi-SQLA](https://github.com/dialoguemd/fastapi-sqla) ⭐ 441 | 🐛 14 | 🌐 Python | 📅 2026-04-03 - SQLAlchemy extension for FastAPI with support for pagination, asyncio, and pytest.
...
* [FastAPIwee](https://github.com/Ignisor/FastAPIwee) ⭐ 106 | 🐛 1 | 🌐 Python | 📅 2021-07-09 - A simple way to create REST API based on [PeeWee](https://github.com/coleifer/peewee) ⭐ 11,958 | 🐛 0 | 🌐 Python | 📅 2026-04-02 models.
...
* [asyncpgsa](https://github.com/CanopyTax/asyncpgsa) ⭐ 510 | 🐛 14 | 🌐 Python | 📅 2024-02-17 - A wrapper around [asyncpg](https://github.com/MagicStack/asyncpg) ⭐ 7,997 | 🐛 267 | 🌐 Python | 📅 2026-02-27 for use with [SQLAlchemy Core](https://docs.sqlalchemy.org/en/latest/core/).
...
* [Wireup](https://github.com/maldoinc/wireup) ⭐ 379 | 🐛 16 | 🌐 Python | 📅 2026-04-01 - Inject dependencies with zero runtime overhead in FastAPI; Share dependencies across web, cli or other interfaces.
...
* [Strawberry GraphQL](https://github.com/strawberry-graphql/strawberry) ⭐ 4,637 | 🐛 447 | 🌐 Python | 📅 2026-04-02 - Python GraphQL library based on dataclasses.
...
* [OpenTelemetry FastAPI Instrumentation](https://github.com/open-telemetry/opentelemetry-python-contrib/tree/main/instrumentation/opentelemetry-instrumentation-fastapi) ⭐ 1,023 | 🐛 657 | 🌐 Python | 📅 2026-04-02 - Library provides automatic and manual instrumentation of FastAPI web frameworks, instrumenting http requests served by applications utilizing the framework.
...
* [Pydantic Resolve](https://github.com/allmonday/pydantic-resolve) ⭐ 318 | 🐛 4 | 🌐 Python | 📅 2026-04-03 -  Turns pydantic class into a powerful composable computing container by introducing resolve and post-process hooks.
...
* [Source Code](https://github.com/fastapi/fastapi) ⭐ 96,791 | 🐛 165 | 🌐 Python | 📅 2026-04-02 - Hosted on GitHub.
...
* [FastAPI Best Practices](https://github.com/zhanymkanov/fastapi-best-practices) ⭐ 16,909 | 🐛 12 | 📅 2026-01-10 - Collection of best practices in a GitHub repo.
* [FastAPI Clean Example](https://github.com/ivan-borovets/fastapi-clean-example) ⭐ 524 | 🐛 3 | 🌐 Python | 📅 2026-04-02 - Clean Architecture backend example built with FastAPI.
...
* [Full Stack FastAPI and PostgreSQL - Base Project Generator](https://github.com/fastapi/full-stack-fastapi-template) ⭐ 42,434 | 🐛 18 | 🌐 TypeScript | 📅 2026-04-02 - Full Stack FastAPI Template
...
* [inboard](https://github.com/br3ndonland/inboard) ⭐ 318 | 🐛 0 | 🌐 Python | 📅 2026-04-03 - Docker images to power your FastAPI apps and help you ship faster.
...
* [Polar](https://github.com/polarsource/polar) ⭐ 9,625 | 🐛 339 | 🌐 Python | 📅 2026-04-02 - A funding and monetization platform for developers, built with FastAPI, SQLAlchemy, Alembic, and Arq.
...
* [Awesome FastAPI Projects](https://github.com/Kludex/awesome-fastapi-projects) ⭐ 1,597 | 🐛 12 | 🌐 TypeScript | 📅 2026-03-30 - Organized list of projects that use FastAPI.
