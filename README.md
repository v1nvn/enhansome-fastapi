...
# Awesome FastAPI | [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 451,969 | 🐛 59 | 📅 2026-04-02 with stars
...
* [SQLAlchemy Admin](https://github.com/aminalaee/sqladmin) ⭐ 2,700 | 🐛 109 | 🌐 Python | 📅 2026-04-04 - Admin Panel for FastAPI/Starlette that works with SQLAlchemy models.
...
* [FastAPI Auth](https://github.com/dmontagu/fastapi-auth) ⭐ 266 | 🐛 5 | 🌐 Python | 📅 2023-02-14 - Pluggable auth that supports the OAuth2 Password Flow with JWT access and refresh tokens.
...
* [FastAPI Guard](https://github.com/rennf93/fastapi-guard) ⭐ 724 | 🐛 1 | 🌐 Python | 📅 2026-03-26 - Rate Limiting, Automatically Ban IPs, Penetration Attack Detection, Whitelist/blacklist (countries, IPs, Cloud Providers), User Agent Filtering, Geolocation, Redis integration for persistence, and more.
...
* [Piccolo](https://github.com/piccolo-orm/piccolo) ⭐ 1,880 | 🐛 38 | 🌐 Python | 📅 2026-03-24 - An async ORM and query builder, supporting Postgres and SQLite, with batteries (migrations, security, etc).
...
* [Fastapi-SQLA](https://github.com/dialoguemd/fastapi-sqla) ⭐ 442 | 🐛 15 | 🌐 Python | 📅 2026-04-04 - SQLAlchemy extension for FastAPI with support for pagination, asyncio, and pytest.
* [Edgy ORM](https://github.com/dymmond/edgy) ⭐ 426 | 🐛 1 | 🌐 Python | 📅 2026-03-06 - Complex databases made simple.
* [Saffier ORM](https://github.com/tarsil/saffier) ⭐ 150 | 🐛 1 | 🌐 Python | 📅 2026-03-26 - The only Python ORM you will ever need.
* [FastAPIwee](https://github.com/Ignisor/FastAPIwee) ⭐ 106 | 🐛 1 | 🌐 Python | 📅 2021-07-09 - A simple way to create REST API based on [PeeWee](https://github.com/coleifer/peewee) ⭐ 11,960 | 🐛 1 | 🌐 Python | 📅 2026-04-02 models.
...
* [PyPika](https://github.com/kayak/pypika) ⭐ 2,898 | 🐛 231 | 🌐 Python | 📅 2026-02-04 - A SQL query builder that exposes the full richness of the SQL language.
...
* [Wireup](https://github.com/maldoinc/wireup) ⭐ 380 | 🐛 18 | 🌐 Python | 📅 2026-04-04 - Inject dependencies with zero runtime overhead in FastAPI; Share dependencies across web, cli or other interfaces.
...
* [Strawberry GraphQL](https://github.com/strawberry-graphql/strawberry) ⭐ 4,638 | 🐛 448 | 🌐 Python | 📅 2026-04-04 - Python GraphQL library based on dataclasses.
...
* [FastAPI Pagination](https://github.com/uriyyo/fastapi-pagination) ⭐ 1,638 | 🐛 6 | 🌐 Python | 📅 2026-04-04 - Pagination for FastAPI.
...
* [OpenTelemetry FastAPI Instrumentation](https://github.com/open-telemetry/opentelemetry-python-contrib/tree/main/instrumentation/opentelemetry-instrumentation-fastapi) ⭐ 1,024 | 🐛 652 | 🌐 Python | 📅 2026-04-03 - Library provides automatic and manual instrumentation of FastAPI web frameworks, instrumenting http requests served by applications utilizing the framework.
...
* [Pydantic Resolve](https://github.com/allmonday/pydantic-resolve) ⭐ 318 | 🐛 5 | 🌐 Python | 📅 2026-04-05 -  Turns pydantic class into a powerful composable computing container by introducing resolve and post-process hooks.
...
* [Source Code](https://github.com/fastapi/fastapi) ⭐ 96,848 | 🐛 165 | 🌐 Python | 📅 2026-04-03 - Hosted on GitHub.
...
* [FastAPI Best Practices](https://github.com/zhanymkanov/fastapi-best-practices) ⭐ 16,917 | 🐛 12 | 📅 2026-01-10 - Collection of best practices in a GitHub repo.
...
* [Full Stack FastAPI and PostgreSQL - Base Project Generator](https://github.com/fastapi/full-stack-fastapi-template) ⭐ 42,470 | 🐛 19 | 🌐 TypeScript | 📅 2026-04-04 - Full Stack FastAPI Template
...
* [FastAPI template](https://github.com/s3rius/FastAPI-template) ⭐ 2,769 | 🐛 41 | 🌐 Python | 📅 2025-11-28 - Flexible, lightweight FastAPI project generator. It includes support for SQLAlchemy, multiple databases, CI/CD, Docker, and Kubernetes.
...
* [Polar](https://github.com/polarsource/polar) ⭐ 9,630 | 🐛 344 | 🌐 Python | 📅 2026-04-04 - A funding and monetization platform for developers, built with FastAPI, SQLAlchemy, Alembic, and Arq.
...
* [FastAPI with Observability](https://github.com/Blueswen/fastapi-observability) ⭐ 1,082 | 🐛 6 | 🌐 Python | 📅 2025-05-11 - Observe FastAPI app with three pillars of observability: Traces (Tempo), Metrics (Prometheus), Logs (Loki) on Grafana through OpenTelemetry and OpenMetrics.
* [Bitcart](https://github.com/bitcart/bitcart) ⭐ 921 | 🐛 38 | 🌐 Python | 📅 2026-04-04 - Platform for merchants, users and developers which offers easy setup and use.
